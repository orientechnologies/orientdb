...
public class OServerCommandGetExplainCommand extends OServerCommandAbstract {
  ...
  public OServerCommandGetExplainCommand(final OServerCommandConfiguration iConfiguration) {
  }
  ...
  public boolean execute(final OHttpRequest iRequest, OHttpResponse iResponse) throws Exception {
    ...
    try {
      ...
      final String result = OMonitorUtils.fetchFromRemoteServer(server.getConfiguration(), remoteUrl, "POST");
