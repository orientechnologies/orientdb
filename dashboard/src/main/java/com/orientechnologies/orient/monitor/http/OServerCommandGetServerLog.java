...
public class OServerCommandGetServerLog extends OServerCommandAuthenticatedServerAbstract {
	...
	public OServerCommandGetServerLog(final OServerCommandConfiguration iConfiguration) {
	...
	public boolean execute(final OHttpRequest iRequest, OHttpResponse iResponse) throws Exception {
      ...
      monitor = OServerMain.server().getPluginByClass(OMonitorPlugin.class);
		...
		final URL remoteUrl = new java.net.URL("http://" + server.field("url") + "/log/" + type + "");
