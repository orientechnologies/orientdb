...
java -server $JAVA_OPTS $JAVA_OPTS_SCRIPT $ORIENTDB_SETTINGS -Djava.util.logging.config.file="$LOG_FILE" -Dorientdb.config.file="$CONFIG_FILE" -Dorientdb.www.path="$WWW_PATH" -Dorientdb.build.number="12631" -cp "$ORIENTDB_HOME/lib/orientdb-server-1.2.0-SNAPSHOT.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/target/classes" com.orientechnologies.orient.server.OServerMain
