...
call %JAVA% -server %JAVA_OPTS% %JAVA_OPTS_SCRIPT% %ORIENTDB_SETTINGS% -Djava.util.logging.config.file="%LOG_FILE%" -Dorientdb.config.file="%CONFIG_FILE%" -Dorientdb.www.path="%WWW_PATH%" -Dorientdb.build.number="12631" -cp "%ORIENTDB_HOME%\lib\*;%ORIENTDB_HOME%\target\classes;" com.orientechnologies.orient.server.OServerMain %CMD_LINE_ARGS%
