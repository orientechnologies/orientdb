...
public class OMulticastNodeDiscoveryTaskTest {
  ...
  public void testTwoGroups() throws InterruptedException {
    ...
    manager1.start();
    OMulticastNodeDiscoveryManager managerOtherGroup = new OMulticastNodeDiscoveryManager("group2", "node1", discoveryListenerOther,
        4323, "235.1.1.1", new int[] { 4321, 4322, 4323 }, scheduler);
