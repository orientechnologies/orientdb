...
public class OMulticastNodeDiscoveryTaskTest {
  ...
  public void test() throws InterruptedException {
    ...
    OMulticastNodeDiscoveryManager manager1 = new OMulticastNodeDiscoveryManager("default", "node1", discoveryListener1, 4321,
    ...
    OMulticastNodeDiscoveryManager manager2 = new OMulticastNodeDiscoveryManager("default", "node2", discoveryListener2, 4322,
        "235.1.1.1", new int[] { 4321, 4322 }, scheduler);
    manager2.start();
    Thread.sleep(2000);
  ...
  public void testEncrypted() throws InterruptedException {
    ...
    OMulticastNodeDiscoveryManager manager1 = new OMulticastNodeDiscoveryManager("default","node1", discoveryListener1, 4321, "235.1.1.1",
    ...
    OMulticastNodeDiscoveryManager manager2 = new OMulticastNodeDiscoveryManager("default","node2", discoveryListener2, 4322, "235.1.1.1",
        new int[] { 4321, 4322 }, scheduler);
