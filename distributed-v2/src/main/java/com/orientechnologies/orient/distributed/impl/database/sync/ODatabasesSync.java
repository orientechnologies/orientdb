...
public class ODatabasesSync {
  ...
  public synchronized void startSync(OrientDBDistributed orientDBDistributed, String database, UUID uuid, boolean incremental) {
    ODatabaseSyncReceiver receiver = new ODatabaseSyncReceiver(orientDBDistributed, database, incremental);
    receiver.run();
