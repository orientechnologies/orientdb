...
public class IndexCrashRestoreSingleValueCT {
  ...
  public void spwanServer() throws Exception {
    ...
    System.out.println(IndexCrashRestoreSingleValueCT.class.getSimpleName() + ": Wait for server start");
    ...
    mutex.close();
    mutexFile.delete();
    System.out.println(IndexCrashRestoreSingleValueCT.class.getSimpleName() + ": Server was started");
  }
