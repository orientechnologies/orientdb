...
public class OLDAPLibrary
{
	...
	public static void retrieveUsers(DirContext ctx, final String baseDN, final String filter, final List<String> principalList, final boolean debug)
	{
		try
		{
			if(ctx != null)
...
//				traverse(ctx, startingDN, filterDN, principalList, debug);
	...
	private static void addPrincipal(SearchResult sr, List<String> principalList, final boolean debug)
	{
		try
		{
...
/*				
	...
	*/			
	...
	private static void traverse(DirContext ctx, String startingDN, String memberOfFilter, List<String> principalList, final boolean debug)
	{
		try
		{
	...
	private static void findMembers(DirContext ctx, String startingDN, String memberOfFilter, List<String> principalList, final boolean debug)
	{
		try
		{
			Attributes attrs = ctx.getAttributes(startingDN);
	...
	private static void fillAttributeList(Attributes attrs, String name, List<String> list, final boolean debug)
	{
		try
		{
