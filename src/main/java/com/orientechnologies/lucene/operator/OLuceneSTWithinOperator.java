...
import com.orientechnologies.lucene.strategy.SpatialQueryBuilderWithin;
...
public class OLuceneSTWithinOperator extends OLuceneSpatialOperator {

  public OLuceneSTWithinOperator() {
    super("ST_WITHIN", 5, false);
  }
