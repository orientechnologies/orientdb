...
public class OLuceneGeoFilterOperator extends OQueryTargetOperator {

  public OLuceneGeoFilterOperator() {
    super("GEO_FILTER", 5, false);
  }
  ...
  public OIndexCursor executeIndexQuery(OCommandContext iContext, OIndex<?> index, List<Object> keyParams, boolean ascSortOrder) {
    ...
    OIndexCursor cursor;
    Object indexResult = index.get(keyParams.get(0));
