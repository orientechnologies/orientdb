...
public class OrientJdbcPreparedStatement extends OrientJdbcStatement implements PreparedStatement {
	...
	public ResultSet executeQuery() throws SQLException {
		...
		try {
			...
			/*
			 * rawResult =
			 * database.command(query).execute(params.values().toArray(new
			 * String[] {}));
			 * 
	...
	public ParameterMetaData getParameterMetaData() throws SQLException {
		...
		final List<OrientJdbcParameterMetadata.ParameterDefinition> definitions =
				new ArrayList<OrientJdbcParameterMetadata.ParameterDefinition>();
