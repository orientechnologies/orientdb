...
public class OrientJdbcResultSetMetaData implements ResultSetMetaData {
	...
	public String getColumnName(int column) throws SQLException {
		...
		else return currentRecord.fieldNames()[column - 1];
	}
	...
	public String getSchemaName(int column) throws SQLException {
		ODocument currentRecord = this.resultSet.unwrap(ODocument.class);
		if (currentRecord == null) return null;
		else return currentRecord.getDatabase().getName();
	}
	...
	public boolean isSigned(int column) throws SQLException {
		...
		else return this.isANumericColumn(currentRecord.fieldType(currentRecord.fieldNames()[column - 1]));
	}
