 ...
 * @since 30.01.13
 */
public class LuceneUniqueSpeedTest extends SpeedTestMonoThread {
  ...
  public void init() throws Exception {
    ...
    hashIndex = databaseDocumentTx.getMetadata().getIndexManager()
        .createIndex("hashIndex", "UNIQUE", new OSimpleKeyIndexDefinition(OType.STRING), new int[0], null, null, "LUCENE");
  }
