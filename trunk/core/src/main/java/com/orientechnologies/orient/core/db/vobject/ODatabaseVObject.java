...
public interface ODatabaseVObject extends ODatabaseRecord<ORecordVObject>, ODatabaseSchemaAware<ORecordVObject> {
	
	public ORecordIteratorMultiCluster<ORecordVObject> browseClass(String iClassName);
