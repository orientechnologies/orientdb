...
public abstract class OrientElementType extends OClassAbstractDelegate {
    ...
    // @Override
    // public OProperty createProperty(final String iPropertyName, final OType
    // iType, final OClass iLinkedClass) {
    ...
    // iLinkedClass);
    // }
    // }, "create ", getTypeName(), " property '", iPropertyName, "' as type '",
    // iType.toString(), "' linked class '",
    // iLinkedClass.getName(), "'");
    // }
    //
    // @Override
    // public OProperty createProperty(final String iPropertyName, final OType
    // iType, final OType iLinkedType) {
    // return graph.executeOutsideTx(new OCallable<OProperty, OrientGraph>() {
    // @Override
    // public OProperty call(final OrientGraph g) {
    // return OrientElementType.super.createProperty(iPropertyName, iType,
    ...
    // }
    // }, "create index '", iName, "' as type '", iType.toString(), "' on
    // fields: " + Arrays.toString(fields));
    // }
    //
    // @Override
    // public OIndex<?> createIndex(final String iName, final String iType,
    // final String... fields) {
    // return graph.executeOutsideTx(new OCallable<OIndex<?>, OrientGraph>() {
    // @Override
    // public OIndex<?> call(final OrientGraph g) {
    ...
    // @Override
    // public OIndex<?> call(final OrientGraph g) {
    // return OrientElementType.super.createIndex(iName, iType,
    // iProgressListener, fields);
    // }
    // }, "create index '", iName, "' as type '", iType.toString(), "' on
    // fields: " + Arrays.toString(fields));
    // }
    ...
    // public OIndex<?> call(final OrientGraph g) {
    // return OrientElementType.super.createIndex(iName, iType,
    // iProgressListener, metadata, algorithm, fields);
    // }
    // }, "create index '", iName, "' as type '", iType.toString(), "' on
    // fields: " + Arrays.toString(fields));
    // }
    ...
    // public OIndex<?> call(final OrientGraph g) {
    // return OrientElementType.super.createIndex(iName, iType,
    // iProgressListener, metadata, fields);
    // }
    // }, "create index '", iName, "' as type '", iType.toString(), "' on
    // fields: " + Arrays.toString(fields));
    // }
