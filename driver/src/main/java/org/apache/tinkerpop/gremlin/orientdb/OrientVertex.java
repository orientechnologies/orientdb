...
public final class OrientVertex extends OrientElement implements Vertex {
    ...
    public Iterator<Vertex> vertices(final Direction direction, final String... labels) {
        ...
        // labels = (String[])
        // Stream.of(labels).map(OrientGraphUtils::encodeClassName).toArray();
    ...
    public Edge addEdge(String label, Vertex inVertex, Object... keyValues) {
        ...
        // if (checkDeletedInTx())
        // throw new IllegalStateException("The vertex " + getIdentity() + " has
        // been deleted");
        //
        // if (inVertex.checkDeletedInTx())
        // throw new IllegalStateException("The vertex " +
        // inVertex.getIdentity() + " has been deleted");
        //
        ...
        // rawElement.getIdentity(), OrientBaseGraph.CONNECTION_IN,
    ...
    public static String getConnectionFieldName(final Direction iDirection, final String iClassName) {
        ...
        // } else
        // "out" or "in"
        // return iDirection == Direction.OUT ? OrientGraphUtils.CONNECTION_OUT
    ...
    public Object createLink(final ODocument iFromVertex, final OIdentifiable iTo, final String iFieldName) {
        ...
        if (found == null) {
            ...
            // if (iGgraph.isAutoScaleEdgeType() && (prop == null || propType ==
            // OType.LINK ||
            // "true".equalsIgnoreCase(prop.getCustom("ordered")))) {
            // // CREATE ONLY ONE LINK
            // out = iTo;
            // outType = OType.LINK;
            // } else if (propType == OType.LINKLIST || (prop != null &&
            // "true".equalsIgnoreCase(prop.getCustom("ordered")))) {
    ...
    public Iterator<Edge> edges(final Direction direction, String... edgeLabels) {
        ...
        // edgeLabels = (String[])
        // Stream.of(edgeLabels).map(OrientGraphUtils::encodeClassName).toArray();
    ...
    private void addSingleVertex(final ODocument doc, final OMultiCollectionIterator<Vertex> iterable, String fieldName,
        ...
        if (immutableClass.isVertexType()) {
            ...
            // OrientEdge.isLabeled(OrientEdge.getRecordLabel(fieldRecord),
            // iLabels)) {
