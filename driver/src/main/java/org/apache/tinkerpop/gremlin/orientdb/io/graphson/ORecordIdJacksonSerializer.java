...
public final class ORecordIdJacksonSerializer extends JsonSerializer<ORecordId> {
  ...
  @Override
  public void serialize(ORecordId value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
  ...
  @Override
  public void serializeWithType(ORecordId value, JsonGenerator jgen, SerializerProvider serializers, TypeSerializer typeSer)
      throws IOException {
