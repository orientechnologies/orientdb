...
public class OrientGraphCountStrategyTest {
    ...
    public void shouldCountWithE() {
        ...
        try {
            ...
            Assert.assertEquals(10, g.E().hasLabel("Rel").count().toStream().findFirst().get().longValue());
    ...
    public void shouldCountWithPerson() {
        ...
        try {
            GraphTraversalSource g = graph.traversal();
            Assert.assertEquals(10, g.V().hasLabel("Person").count().toStream().findFirst().get().longValue());
