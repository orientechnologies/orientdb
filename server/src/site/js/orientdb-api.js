...
function ODatabase(databasePath) {
    ...
    ODatabase.prototype.create = function (userName, userPass, type, databaseType) {
        if (userName == null)
            userName = '';
     ...
     */
    ODatabase.prototype.executeCommand = function (iCommand, iLanguage, iLimit, iFetchPlan) {
        return this.command(iCommand, iLanguage, iLimit, iFetchPlan);
    }

    ODatabase.prototype.command = function (iCommand, iLanguage, iLimit, iFetchPlan) {
        if (this.databaseInfo == null)
            this.open();
    ...
    ODatabase.prototype.process = function (iName, iParameters, iSuccessCallback, iErrorCallback, iAdditionalArguments) {
        return this.executeLogic(iName, iParameters, "process",
            iSuccessCallback, iErrorCallback, iAdditionalArguments);
    }
    ODatabase.prototype.executeFunction = function (iName, iParameters, iSuccessCallback, iErrorCallback, iAdditionalArguments) {
        return this.executeLogic(iName, iParameters, "function",
            iSuccessCallback, iErrorCallback, iAdditionalArguments);
    }

    ODatabase.prototype.executeAction = function (iName, iParameters, iSuccessCallback, iErrorCallback, iAdditionalArguments) {
        return this.executeLogic(iName, iParameters, "action",
            iSuccessCallback, iErrorCallback, iAdditionalArguments);
    }

    ODatabase.prototype.executeLogic = function (iName, iParameters, iType, iSuccessCallback, iErrorCallback, iAdditionalArguments) {
        if (this.databaseInfo == null)
            this.open();
    ...
    ODatabase.prototype.importRecords = function (content, configuration, errorCallback, successCallback) {
        if (this.databaseInfo == null)
            this.open();
    ...
    ODatabase.prototype.removeCircleReferencesChangeObject = function (obj, linkMap) {
        for (var field in obj) {
            if (!obj.hasOwnProperty(field)) {
                continue;
            }
