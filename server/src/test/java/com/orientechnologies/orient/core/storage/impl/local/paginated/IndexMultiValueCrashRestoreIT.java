 ...
 * @since 9/25/14
 */
public class IndexMultiValueCrashRestoreIT {
  ...
  public IndexMultiValueCrashRestoreIT() {
  ...
  public void spawnServer() throws Exception {
    ...
    System.out.println(IndexMultiValueCrashRestoreIT.class.getSimpleName() + ": Wait for server start");
    ...
    mutex.close();
    mutexFile.delete();
    System.out.println(IndexMultiValueCrashRestoreIT.class.getSimpleName() + ": Server was started");
  }
