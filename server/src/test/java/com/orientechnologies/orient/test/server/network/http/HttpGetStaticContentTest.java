...
public class HttpGetStaticContentTest extends BaseHttpTest {
  ...
  public void registerFakeVirtualFolder() {
    ...
    final OServerNetworkListener httpListener = getServer().getListenerByProtocol(ONetworkProtocolHttpAbstract.class);
  ...
  public void testIndexHTML() throws Exception {
    ...
    String expected = OIOUtils.readStreamAsString(this.getClass().getClassLoader().getResourceAsStream("index.htm"));
