 ...
 * 
 */
public class OClusterDiscoveryManager implements OServerHandler {
	...
	private OClusterNode									leader						= null;
	private HashMap<String, OClusterNode>	nodes							= new HashMap<String, OClusterNode>();	;
