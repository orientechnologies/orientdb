...
public abstract class ONetworkProtocolHttpAbstract extends ONetworkProtocol {
  ...
  public void service() throws ONetworkProtocolException, IOException {
    ...
    if (OGlobalConfiguration.NETWORK_HTTP_JSONP_ENABLED.getValueAsBoolean() && request.parameters != null && request.parameters
        .containsKey(OHttpUtils.CALLBACK_PARAMETER_NAME))
