...
public abstract class OServerCommandAuthenticatedServerAbstract extends OServerCommandAbstract {
  ...
  protected void sendNotAuthorizedResponse(final OHttpRequest iRequest, final OHttpResponse iResponse) throws IOException {
    ...
    iResponse.sendTextContent(OHttpUtils.STATUS_FORBIDDEN_CODE, OHttpUtils.STATUS_FORBIDDEN_DESCRIPTION, "WWW-Authenticate: Basic realm=\"OrientDB Server\"",
        OHttpUtils.CONTENT_TEXT_PLAIN, "403 Forbidden.", false);
  }

  protected void sendAuthorizationRequest(final OHttpRequest iRequest, final OHttpResponse iResponse) throws IOException {
    // UNAUTHORIZED
    iRequest.sessionId = SESSIONID_UNAUTHORIZED;
    iResponse.sendTextContent(OHttpUtils.STATUS_AUTH_CODE, OHttpUtils.STATUS_AUTH_DESCRIPTION, "WWW-Authenticate: Basic realm=\"OrientDB Server\"",
        OHttpUtils.CONTENT_TEXT_PLAIN, "401 Unauthorized.", false);
  }
}
