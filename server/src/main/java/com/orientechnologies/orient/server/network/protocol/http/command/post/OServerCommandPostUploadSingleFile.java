  ...
  public void saveRecord(OHttpRequest iRequest, final OHttpResponse iResponse) throws InterruptedException, IOException {
    if (fileDocument != null) {
      if (fileRID != null) {
        ...
        iResponse.sendTextContent(OHttpUtils.STATUS_INVALIDMETHOD_CODE, "File cannot be null", OHttpUtils.CONTENT_TEXT_PLAIN, "File cannot be null",
            null);
      }
      ...
      iResponse.sendTextContent(OHttpUtils.STATUS_INVALIDMETHOD_CODE, "Document template cannot be null", OHttpUtils.CONTENT_TEXT_PLAIN, "Document template cannot be null",
          null);
    }
  }
