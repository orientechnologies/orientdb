...
public class OServerSSLCertificateManager {
    ...
    private void initOSelfSignedCertificateParameters() {
        ...
        this.oSelfSignedCertificate.setCertificate_name(OSelfSignedCertificate.DEFAULT_CERTIFICATE_NAME);
        try {
            this.oSelfSignedCertificate.setCertificate_SN(0);// trick to force it to conpute a random BigInteger
    ...
    public static void initKeyStore(File keyStore_FilePointer, KeyStore keyStore_instance, char[] ks_pwd) throws IOException, CertificateException, NoSuchAlgorithmException {
    ...
    public static void loadKeyStore(File keyStore_FilePointer, KeyStore keyStore_instance, char[] ks_pwd) throws IOException, CertificateException, NoSuchAlgorithmException {
    ...
    public static void storeCertificate(X509Certificate cert, PrivateKey key, String cert_name, char[] cert_pwd, File keyStore_FilePointer, KeyStore keyStore_instance, char[] ks_pwd) throws KeyStoreException, IOException, CertificateException, NoSuchAlgorithmException {

        FileOutputStream ks_FOs = null;
        try {
            ks_FOs = new FileOutputStream(keyStore_FilePointer,true);

            keyStore_instance.setKeyEntry(cert_name, key, cert_pwd,  new java.security.cert.Certificate[]{cert});
    ...
    public static void trustCertificate(File keyStore_FilePointer, KeyStore keyStore_instance, char[] ks_pwd, String cert_name, X509Certificate cert) throws KeyStoreException, IOException, CertificateException, NoSuchAlgorithmException {
