 ...
 */
public class OTransactionOptimisticServer37 extends OTransactionOptimisticServer {

  protected List<ORecordOperationRequest> operations;

  public OTransactionOptimisticServer37(ODatabaseDocumentInternal database, int txId, boolean usingLong,
