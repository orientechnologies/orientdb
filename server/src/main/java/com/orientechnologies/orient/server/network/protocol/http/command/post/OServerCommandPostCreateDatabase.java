...
public class OServerCommandPostCreateDatabase extends OServerCommandAuthenticatedServerAbstract {
	private static final String[]	NAMES	= { "POST|createDatabase/*" };

	public OServerCommandPostCreateDatabase() {
		super("info-server");
	}

	@Override
	public boolean execute(final OHttpRequest iRequest) throws Exception {
		String[] urlParts = checkSyntax(iRequest.url, 3, "Syntax error: createDatabase/<db>/<type>");
