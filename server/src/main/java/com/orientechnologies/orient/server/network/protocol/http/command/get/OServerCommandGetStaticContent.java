    ...
    try {
      ...
      if (is == null) {
        ...
        if (!inputFile.exists()) {
          ...
          iResponse.sendBinaryContent(iRequest, 404, "File not found", null, null, 0);
          return false;
        }
      ...
      iResponse.sendBinaryContent(iRequest, OHttpUtils.STATUS_OK_CODE, OHttpUtils.STATUS_OK_DESCRIPTION, type, is, contentSize);
