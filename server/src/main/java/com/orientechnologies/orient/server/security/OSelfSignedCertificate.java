...
//    public static final String PARAM_NETWORK_SSL_TRUSTSTORE_PASSWORD = "network.ssl.trustStorePassword";
    ...
    public static final String DEFAULT_CERTIFICATE_NAME = "AutoGeneratedSelfSigned_certificate";
...
//    }
    ...
    public static KeyStore createKeyStore(X509Certificate cert, PrivateKey key, String cert_name, char[] cert_pwd, char[] ks_pwd, String ks_type, String ks_file_path) throws KeyStoreException, IOException, SwitchToDefaultParamsException, CertificateException, NoSuchAlgorithmException {
        ...
        ks_Fp = new File(ks_file_path);
        if (!ks_Fp.isAbsolute()) {
            ks_Fp =
                    new File(
                            OSystemVariableResolver.resolveSystemVariables(DEFAULT_KEYSTORE_PATH, ks_file_path));
        }
