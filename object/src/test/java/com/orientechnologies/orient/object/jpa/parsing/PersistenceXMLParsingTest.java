...
import static javax.persistence.spi.PersistenceUnitTransactionType.*;
...
public class PersistenceXMLParsingTest {
  ...
  public void testFile1() throws Exception {
    ...
    assertPersistenceUnit(iterator.next(), new Rule[] { //
        ...
        new Rule("The properties should never be null",
            asProperty("some.prop", "prop.value", "some.other.prop", "another.prop.value"), "getProperties") });
