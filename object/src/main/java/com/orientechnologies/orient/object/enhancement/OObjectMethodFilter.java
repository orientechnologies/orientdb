...
public class OObjectMethodFilter implements MethodFilter {
  ...
  private static Map<Method, String> fieldNameCache = new HashMap<Method, String>();
  private static Map<Method, Boolean> isSetterCache = new HashMap<Method, Boolean>();
  private static Map<Method, Boolean> isGetterCache = new HashMap<Method, Boolean>();
  ...
  protected boolean isScalaClass(Class<?> clz) {
    Annotation[] annotations = OReflectionUtils.getDeclaredAnnotations(clz);
