...
schemaModule.controller("ClassEditController",['$scope','$routeParams','$location','Database','CommandApi','$modal','$q',function($scope,$routeParams,$location,Database,CommandApi,$modal,$q){
		...
		// console.log($scope.property[result][elementName])
			// delete ($scope.property[element]);		
		}
