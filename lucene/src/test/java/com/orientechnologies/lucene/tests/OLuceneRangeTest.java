...
public class OLuceneRangeTest extends OLuceneBaseTest {
  ...
  public void shouldUseRangeQueryOnSingleFloatField() throws Exception {
    ...
    assertThat(db.getMetadata().getIndexManagerInternal().getIndex(db, "Person.weight").size()).isEqualTo(10);
  ...
  public void shouldUseRangeQueryOnSingleIntegerField() {
    ...
    assertThat(db.getMetadata().getIndexManagerInternal().getIndex(db, "Person.age").size()).isEqualTo(10);
  ...
  public void shouldUseRangeQueryOnSingleDateField() throws Exception {
    ...
    assertThat(db.getMetadata().getIndexManagerInternal().getIndex(db, "Person.date").size()).isEqualTo(10);
  ...
  public void shouldUseRangeQueryMultipleField() throws Exception {
    ...
    assertThat(db.getMetadata().getIndexManagerInternal().getIndex(db, "Person.composite").size()).isEqualTo(10);
