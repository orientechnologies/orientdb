...
public class LuceneCreateIndexWithStopwordsTest extends LuceneSingleFieldEmbeddedTest {

  public LuceneCreateIndexWithStopwordsTest() {
    this(false);
  }

  public LuceneCreateIndexWithStopwordsTest(boolean remote) {
    super(remote);
  }
