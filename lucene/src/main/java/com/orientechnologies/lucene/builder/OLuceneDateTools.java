 ...
 * <p>
 * It uses the {@link java.util.TimeZone} defined at database level and maintains only methods for string conversion to {@link Date}
 * or long value.
 *
 * @author frank
 */
public class OLuceneDateTools {
  ...
  public enum Resolution {
    ...
    public SimpleDateFormat format() {
      ...
      SimpleDateFormat format = new SimpleDateFormat("yyyyMMddHHmmssSSS".substring(0, formatLen), Locale.ROOT);
