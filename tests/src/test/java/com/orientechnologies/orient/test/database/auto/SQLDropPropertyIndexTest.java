...
public class SQLDropPropertyIndexTest {
    ...
    public void testForcePropertyEnabledBrokenCase() throws Exception {
        database.command(new OCommandSQL("CREATE INDEX DropPropertyIndexCompositeIndex ON DropPropertyIndexTestClass (prop2, prop1) UNIQUE")).
                execute();
        database.getMetadata().getIndexManager().reload();
    ...
    public void testForcePropertyDisabled() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals(e.getMessage(), "Property contains in indexes (" +
