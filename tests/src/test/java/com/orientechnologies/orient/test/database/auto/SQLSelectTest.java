...
public class SQLSelectTest {
	...
	@Test
	public void queryFieldCase() {
		database.open("admin", "admin");

		List<ODocument> result = database.command(new OSQLSynchQuery<ODocument>("select from Profile  where name = 'Giuseppe'"))
				.execute();
		List<ODocument> resultCase = database.command(new OSQLSynchQuery<ODocument>("select from Profile  where NAME = 'Giuseppe'"))
				.execute();
		List<ODocument> resultCase2 = database.command(new OSQLSynchQuery<ODocument>("select from Profile  where NaMe = 'Giuseppe'"))
				.execute();
