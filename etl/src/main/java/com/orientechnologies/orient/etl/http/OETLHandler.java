...
public class OETLHandler {
  ...
  public void saveConfiguration(ODocument args, OServer server) throws Exception {
    ...
    final ODocument migrationConfig = new ODocument().fromJSON((String) args.field("migrationConfig"), "noMap");
    ...
    // fetching the server orientdb home and updating coherently the target database URL if we have an orientdb loader
