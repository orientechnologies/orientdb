...
public class ODemoDbFromDocumentationCustomersIT extends OIntegrationTestTemplate {
  ...
  public void test_Customers_Example_2() throws Exception {
    ...
    OResultSet resultSet = db
        .query("MATCH {class: Customers, as: customer, where: (OrderedId=1)}--{Class: Locations} \n" + "RETURN $pathelements");
  ...
  public void test_Customers_Example_5() throws Exception {
    ...
    OResultSet resultSet = db
        .query("MATCH {as: n}<-HasStayed-{class: Customers, as: c, where: (OrderedId=2)} \n" + "RETURN $pathelements");
  ...
  public void test_Customers_Example_6() throws Exception {
    ...
    OResultSet resultSet = db
        .query("MATCH {as: n}<-HasEaten-{class: Customers, as: c, where: (OrderedId=1)} \n" + "RETURN $pathelements");
