 ...
 * The constructor looks for a "properties" field on the OUser document.
...
public class OUserSymmetricKeyConfig implements OSymmetricKeyConfig {
  ...
  public OUserSymmetricKeyConfig(final OUser user) {
    ...
    if(!(id instanceof ODocument)) throw new OSecurityException("OUserSymmetricKeyConfig() Identity is not an ODocument");
    
    ODocument doc = (ODocument)id;
   	  	   
    ODocument props = doc.field("properties");

    if(props == null) throw new OSecurityException("OUserSymmetricKeyConfig() OUser properties is null");
    ...
    if(this.keyString != null) {
    	...
    	if(this.keyAlgorithm == null) throw new OSecurityException("OUserSymmetricKeyConfig() keyAlgorithm is required with key");
    }
    else {
      ...
      if(this.keyFile != null) {
        ...
        if(this.keyAlgorithm == null) throw new OSecurityException("OUserSymmetricKeyConfig() keyAlgorithm is required with keyFile");
      }
      else {
        ...
        if(this.keystoreFile == null) throw new OSecurityException("OUserSymmetricKeyConfig() keyStore.file is required");
        if(this.keystoreKeyAlias == null) throw new OSecurityException("OUserSymmetricKeyConfig() keyStore.keyAlias is required");
      }
    }
  }
}
