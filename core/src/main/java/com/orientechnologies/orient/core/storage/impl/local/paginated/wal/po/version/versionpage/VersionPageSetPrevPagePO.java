...
public final class VersionPageSetPrevPagePO extends PageOperationRecord {
  private int oldPrevPage;
  private int prevPage;

  public VersionPageSetPrevPagePO() {}

  public VersionPageSetPrevPagePO(int oldPrevPage, int prevPage) {
