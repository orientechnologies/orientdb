...
public final class CellBTreeMultiValueV2BucketSetRightSiblingPO extends PageOperationRecord {
  ...
  public CellBTreeMultiValueV2BucketSetRightSiblingPO() {
  }

  public CellBTreeMultiValueV2BucketSetRightSiblingPO(long sibling, long prevSibling) {
  ...
  @Override
  public int getId() {
    return WALRecordTypes.CELL_BTREE_BUCKET_MULTI_VALUE_V2_SET_RIGHT_SIBLING_PO;
  }
