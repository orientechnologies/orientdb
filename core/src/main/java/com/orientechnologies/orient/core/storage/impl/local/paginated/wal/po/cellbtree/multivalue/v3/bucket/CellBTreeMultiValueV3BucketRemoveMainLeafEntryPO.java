...
public final class CellBTreeMultiValueV3BucketRemoveMainLeafEntryPO extends PageOperationRecord {
  private int    index;
  private byte[] key;
  private ORID   value;
  private long   mId;

  public CellBTreeMultiValueV3BucketRemoveMainLeafEntryPO() {
  }

  public CellBTreeMultiValueV3BucketRemoveMainLeafEntryPO(int index, byte[] key, ORID value, long mId) {
    this.index = index;
    this.key = key;
    this.value = value;
    this.mId = mId;
  ...
  @Override
  public int getId() {
    return WALRecordTypes.CELL_BTREE_BUCKET_MULTI_VALUE_V3_REMOVE_MAIN_LEAF_ENTRY_PO;
  }
