 ...
 * 
 */
public enum OSQLDefinitionFieldOperator {
	...
	protected static final OSQLDefinitionFieldOperator[]	OPERATORS				= { SIZE, LENGTH, TOUPPERCASE, TOLOWERCASE, TRIM, LEFT, RIGHT,
	...
	OSQLDefinitionFieldOperator(final int iId, final String iKeyword) {
		this(iId, iKeyword, 0, 0);
	}

	OSQLDefinitionFieldOperator(final int iId, final String iKeyword, int iExactArgs) {
		id = iId;
		keyword = iKeyword;
	...
	OSQLDefinitionFieldOperator(final int iId, final String iKeyword, int iMinArgs, int iMaxArgs) {
		id = iId;
		keyword = iKeyword;
