...
public class OLiveQueryHook {
  private static final OLogger logger = OLogManager.instance().logger(OLiveQueryHook.class);
  ...
  public static void notifyForTxChanges(ODatabaseDocumentEmbedded iDatabase) {
