 ...
 * Typically it means that magic number stored inside of the page of hash code generated by data does not match
 * values stored in page itself. Listener should either delegate code to other thread or should execute operations
 * which will consume very small amount of time.
 */
