 ...
 * The higher priority we have the earlier this handler will be executed.
 * <p>
 * There are set of predefined priorities which are used for system shutdown handlers which allows to add your handlers before , between and
 * after them.
 *
...
public interface OShutdownHandler {
  ...
  /**
   * Priority of {@link com.orientechnologies.orient.core.Orient.OShutdownCallListenersHandler} handler.
   */
  ...
  /**
   * Code which executed during system shutdown. During call of {@link Orient#shutdown()} method which is called during JVM
   * shutdown.
   */
