...
public class CellBTreeBucketSingleValueV1AddAllPO extends PageOperationRecord {
  ...
  public CellBTreeBucketSingleValueV1AddAllPO(List<byte[]> rawRecords, boolean isEncrypted, OBinarySerializer keySerializer) {
  ...
  public void undo(OCacheEntry cacheEntry) {
    final OCellBTreeBucketSingleValue bucket = new OCellBTreeBucketSingleValue(cacheEntry);
    //noinspection unchecked
    bucket.shrink(0, isEncrypted, keySerializer);
  }
  ...
  public int serializedSize() {
    int serializedSize =
        2 * OByteSerializer.BYTE_SIZE + OIntegerSerializer.INT_SIZE + OIntegerSerializer.INT_SIZE * rawRecords.size();
