...
public class CellBTreeMultiValueV2NullBucketIncrementSizePO extends PageOperationRecord {
  ...
  @Override
  public int getId() {
    return WALRecordTypes.CELL_BTREE_NULL_BUCKET_MULTI_VALUE_V2_INCREMENT_SIZE_PO;
  }
}
