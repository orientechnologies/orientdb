...
public interface OrientSqlTreeConstants
{
  ...
  public int JJTCREATECLUSTERSTATEMENT = 150;
  public int JJTALTERCLUSTERSTATEMENT = 151;
  public int JJTDROPCLUSTERSTATEMENT = 152;
  public int JJTALTERDATABASESTATEMENT = 153;
  public int JJTCOMMANDLINEOPTION = 154;
  public int JJTOPTIMIZEDATABASESTATEMENT = 155;
  public int JJTCREATELINKSTATEMENT = 156;
  public int JJTEXPLAINSTATEMENT = 157;
  public int JJTPERMISSION = 158;
  public int JJTRESOURCEPATHITEM = 159;
  public int JJTGRANTSTATEMENT = 160;
  public int JJTREVOKESTATEMENT = 161;
  public int JJTCREATEFUNCTIONSTATEMENT = 162;
  ...
  public int JJTCONSOLESTATEMENT = 170;
  public int JJTCREATESEQUENCESTATEMENT = 171;
  public int JJTALTERSEQUENCESTATEMENT = 172;
  public int JJTDROPSEQUENCESTATEMENT = 173;
  public int JJTHASTATUSSTATEMENT = 174;
  public int JJTHAREMOVESERVERSTATEMENT = 175;
  public int JJTHASYNCDATABASESTATEMENT = 176;
  public int JJTHASYNCCLUSTERSTATEMENT = 177;
...
/* JavaCC - OriginalChecksum=4e7631088c04c7a75e7fefb94af204b6 (do not edit this line) */
