...
public final class CellBTreeMultiValueV3BucketAppendNewLeafEntryPO extends PageOperationRecord {
  private int  index;
  private ORID value;

  public CellBTreeMultiValueV3BucketAppendNewLeafEntryPO() {
  }

  public CellBTreeMultiValueV3BucketAppendNewLeafEntryPO(int index, ORID value) {
    this.index = index;
    this.value = value;
  }
  ...
  @Override
  public int getId() {
    return WALRecordTypes.CELL_BTREE_BUCKET_MULTI_VALUE_V3_APPEND_NEW_LEAF_ENTRY_PO;
  }
