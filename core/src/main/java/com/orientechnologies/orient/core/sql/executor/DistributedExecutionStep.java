...
public class DistributedExecutionStep extends AbstractExecutionStep {
  ...
  public DistributedExecutionStep(OSelectExecutionPlan subExecutionPlan, ONodeId nodeName) {
    super();
  ...
  private OExecutionStream sendSerializedExecutionPlan(
      ONodeId nodeName, OInternalExecutionPlan serializedExecutionPlan, OCommandContext ctx) {
