...
private int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 64:
         return jjStartNfaWithStates_0(0, 97, 534);
      case 91:
...
private int jjMoveNfa_0(int startState, int curPos)
{
   ...
   for (;;)
   {
      ...
      ++curPos;
      if ((i = jjnewStateCnt) == (startsAt = 616 - (jjnewStateCnt = startsAt)))
         return curPos;
      try { curChar = input_stream.readChar(); }
...
static final int[] jjnextStates = {
   61, 62, 10, 65, 66, 69, 70, 583, 585, 591, 592, 594, 21, 34, 12, 13, 
   15, 580, 581, 22, 23, 33, 600, 602, 581, 603, 610, 35, 37, 23, 33, 22, 
   23, 33, 35, 37, 23, 33, 6, 7, 10, 12, 13, 17, 15, 25, 26, 29, 
   30, 32, 28, 36, 23, 33, 37, 23, 33, 61, 62, 10, 71, 72, 10, 162, 
   141, 142, 591, 592, 594, 591, 592, 596, 594, 604, 605, 611, 612, 613, 534, 538, 
   541, 546, 553, 557, 560, 563, 568, 574, 516, 520, 523, 525, 530, 487, 488, 492, 
   497, 509, 472, 475, 481, 484, 461, 462, 466, 441, 446, 451, 456, 423, 427, 434, 
   413, 415, 401, 403, 405, 407, 408, 384, 388, 392, 395, 372, 375, 351, 356, 361, 
   366, 339, 342, 328, 333, 303, 308, 314, 317, 225, 230, 236, 243, 253, 263, 275, 
   286, 292, 109, 114, 117, 125, 126, 135, 163, 181, 202, 94, 101, 102, 76, 81, 
   83, 86, 8, 9, 14, 16, 18, 63, 64, 67, 68, 73, 74, 141, 142, 586, 
   587, 589, 593, 595, 597, 606, 607, 608, 609, 614, 615, 
};
...
static final long[] jjtoToken = {
   0xffffffffffffffe1L, 0xfffffffffff84401L, 0x27fffffffL, 
};
static final long[] jjtoSkip = {
   0x1eL, 0x0L, 0x0L, 
};
protected CharStream input_stream;
private final int[] jjrounds = new int[616];
private final int[] jjstateSet = new int[1232];
