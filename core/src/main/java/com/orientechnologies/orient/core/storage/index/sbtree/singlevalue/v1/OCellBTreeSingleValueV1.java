...
public final class OCellBTreeSingleValueV1<K> extends ODurableComponent implements OCellBTee<K> {
  ...
  public void create(final OBinarySerializer<K> keySerializer, final OType[] keyTypes, final int keySize,
    ...
    try {
      ...
      try {
        ...
        try {
          final OEntryPointV1<K> entryPoint = new OEntryPointV1<>(entryPointCacheEntry);
          entryPoint.init();
        } finally {
        ...
        try {
          ...
          final OCellBTreeBucketV1<K> rootBucket = new OCellBTreeBucketV1<>(rootCacheEntry, true, keySerializer, keyTypes,
              encryption);
        } finally {
        ...
        try {
          @SuppressWarnings("unused")
          final ONullBucketV1 nullBucket = new ONullBucketV1(nullCacheEntry, true);
        } finally {
    ...
    try {
      ...
      try {
        ...
        if (key != null) {
          ...
          try {
            final OCellBTreeBucketV1<K> keyBucket = new OCellBTreeBucketV1<>(keyBucketCacheEntry, keySerializer, keyTypes,
                encryption);
          ...
          try {
            final ONullBucketV1 nullBucket = new ONullBucketV1(nullBucketCacheEntry, false);
      ...
      throw OException
          .wrapException(new OCellBTreeSingleValueExceptionV1("Error during retrieving  of sbtree with name " + getName(), this),
              e);
    } finally {
      ...
      try {
        if (key != null) {
          ...
          OCacheEntry keyBucketCacheEntry = loadPageForWrite(atomicOperation, fileId, bucketSearchResult.getLastPathItem(), false,
              true);
          OCellBTreeBucketV1<K> keyBucket = new OCellBTreeBucketV1<>(keyBucketCacheEntry, keySerializer, keyTypes, encryption);
          ...
          while (!keyBucket.addLeafEntry(insertionIndex, rawKey, serializedValue)) {
            ...
            keyBucket = new OCellBTreeBucketV1<>(keyBucketCacheEntry, keySerializer, keyTypes, encryption);
          }
          ...
          try {
            final ONullBucketV1 nullBucket = new ONullBucketV1(cacheEntry, false);
  ...
  public void clear() throws IOException {
    ...
    try {
      ...
      try {
        ...
        try {
          final ONullBucketV1 nullBucket = new ONullBucketV1(nullCacheEntry, false);
        ...
        try {
          @SuppressWarnings("unused")
          final OCellBTreeBucketV1<K> rootBucket = new OCellBTreeBucketV1<>(cacheEntry, true, keySerializer, keyTypes, encryption);
        } finally {
          releasePageFromWrite(atomicOperation, cacheEntry);
        }
      } finally {
  ...
  public void load(final String name, final int keySize, final OType[] keyTypes, final OBinarySerializer<K> keySerializer,
    ...
    try {
      ...
      throw OException.wrapException(new OCellBTreeSingleValueExceptionV1("Exception during loading of sbtree " + name, this), e);
    } finally {
      releaseExclusiveLock();
    }
  }
  ...
  public long size() {
    ...
    try {
      ...
      throw OException
          .wrapException(new OCellBTreeSingleValueExceptionV1("Error during retrieving of size of index " + getName(), this), e);
    } finally {
      atomicOperationsManager.releaseReadLock(this);
    }
  }
  ...
  private ORID removeKey(final OAtomicOperation atomicOperation, final BucketSearchResult bucketSearchResult) throws IOException {
    ...
    try {
      final OCellBTreeBucketV1<K> keyBucket = new OCellBTreeBucketV1<>(keyBucketCacheEntry, keySerializer, keyTypes, encryption);
  ...
  public K firstKey() {
    ...
    try {
      ...
      try {
        ...
        try {
          final OCellBTreeBucketV1<K> bucket = new OCellBTreeBucketV1<>(cacheEntry, keySerializer, keyTypes, encryption);
      ...
      throw OException
          .wrapException(new OCellBTreeSingleValueExceptionV1("Error during finding first key in sbtree [" + getName() + "]", this),
              e);
    } finally {
      atomicOperationsManager.releaseReadLock(this);
    }
  ...
  public K lastKey() {
    ...
    try {
      ...
      throw OException
          .wrapException(new OCellBTreeSingleValueExceptionV1("Error during finding last key in sbtree [" + getName() + "]", this),
              e);
    } finally {
      atomicOperationsManager.releaseReadLock(this);
    }
  ...
  private BucketSearchResult firstItem(final OAtomicOperation atomicOperation) throws IOException {
    ...
    int itemIndex = 0;
    try {
      OCellBTreeBucketV1<K> bucket = new OCellBTreeBucketV1<>(cacheEntry, keySerializer, keyTypes, encryption);
      ...
      while (true) {
        ...
        bucket = new OCellBTreeBucketV1<>(cacheEntry, keySerializer, keyTypes, encryption);
      }
    } finally {
      releasePageFromRead(atomicOperation, cacheEntry);
    }
      ...
      while (true) {
        if (!bucket.isLeaf()) {
          if (itemIndex < -1) {
            ...
            itemIndex = OCellBTreeBucketV1.MAX_PAGE_SIZE_BYTES + 1;
          }
        } else {
          if (bucket.isEmpty()) {
            if (!path.isEmpty()) {
        ...
        bucket = new OCellBTreeBucketV1<>(cacheEntry, keySerializer, keyTypes, encryption);
        if (itemIndex == OCellBTreeBucketV1.MAX_PAGE_SIZE_BYTES + 1) {
  ...
  private UpdateBucketSearchResult splitBucket(final OCellBTreeBucketV1<K> bucketToSplit, final OCacheEntry entryToSplit,
  ...
  private UpdateBucketSearchResult splitNonRootBucket(final List<Long> path, final List<Integer> itemPointers, final int keyIndex,
      final long pageIndex, final OCellBTreeBucketV1<K> bucketToSplit, final boolean splitLeaf, final int indexToSplit,
    ...
    try {
      final OCellBTreeBucketV1<K> newRightBucket = new OCellBTreeBucketV1<>(rightBucketEntry, splitLeaf, keySerializer, keyTypes,
          encryption);
      ...
      if (splitLeaf) {
        ...
        if (rightSiblingPageIndex >= 0) {
          ...
          final OCellBTreeBucketV1<K> rightSiblingBucket = new OCellBTreeBucketV1<>(rightSiblingBucketEntry, keySerializer,
              keyTypes, encryption);
          try {
      ...
      try {
        OCellBTreeBucketV1<K> parentBucket = new OCellBTreeBucketV1<>(parentCacheEntry, keySerializer, keyTypes, encryption);
        final OCellBTreeBucketV1.SBTreeEntry<K> parentEntry = new OCellBTreeBucketV1.SBTreeEntry<>((int) pageIndex,
        ...
        while (!parentBucket.addEntry(insertionIndex, parentEntry, true)) {
          ...
          parentBucket = new OCellBTreeBucketV1<>(parentCacheEntry, keySerializer, keyTypes, encryption);
        }
  ...
  private UpdateBucketSearchResult splitRootBucket(final int keyIndex, final OCacheEntry bucketEntry,
      OCellBTreeBucketV1<K> bucketToSplit, final boolean splitLeaf, final int indexToSplit, final K separationKey,
    ...
    try {
      final OCellBTreeBucketV1<K> newLeftBucket = new OCellBTreeBucketV1<>(leftBucketEntry, splitLeaf, keySerializer, keyTypes,
          encryption);
    ...
    bucketToSplit = new OCellBTreeBucketV1<>(bucketEntry, false, keySerializer, keyTypes, encryption);
    bucketToSplit.addEntry(0,
        new OCellBTreeBucketV1.SBTreeEntry<>((int) leftBucketEntry.getPageIndex(), (int) rightBucketEntry.getPageIndex(),
  ...
  private BucketSearchResult findBucket(final K key, final OAtomicOperation atomicOperation) throws IOException {
    ...
    while (true) {
      ...
      if (depth > MAX_PATH_LENGTH) {
        throw new OCellBTreeSingleValueExceptionV1(
      ...
      try {
        final OCellBTreeBucketV1<K> keyBucket = new OCellBTreeBucketV1<>(bucketEntry, keySerializer, keyTypes, encryption);
  ...
  private Map.Entry<K, ORID> convertToMapEntry(final OCellBTreeBucketV1.SBTreeEntry<K> treeEntry) {
  ...
  public final class OCellBTreeFullKeyCursor implements OCellBTreeKeyCursor<K> {
    ...
    public K next(int prefetchSize) {
      ...
      try {
        ...
        throw OException
            .wrapException(new OCellBTreeSingleValueExceptionV1("Error during element iteration", OCellBTreeSingleValueV1.this), e);
      } finally {
