...
public interface ORecord extends ORecordElement, OIdentifiable, Serializable, OSerializableStream {
   ...
   *
   * <p>Use {@link ODatabaseSession#load(ORecord)} instead.
   *
   ...
   * thrown.
   *
   * <p>Use {@link ODatabaseSession#reload(OElement)} instead.
   *
   * @return The Object instance itself giving a "fluent interface". Useful to call multiple methods
   *     in chain.
   */
   ...
   *
   * <p>Use {@link ODatabaseSession#save(ORecord)} instead.
   *
   * @return The Object instance itself giving a "fluent interface". Useful to call multiple methods
   *     in chain.
   */
   ...
   *
   * <p>Use {@link ODatabaseSession#save(ORecord, String)} instead.
   *
   * @return The Object instance itself giving a "fluent interface". Useful to call multiple methods
   *     in chain.
   */
  ...
  /**
   * Use {@link ODatabaseSession#save(ORecord, String)} instead.
   *
   * @return
   */
  @Deprecated(forRemoval = true)
