...
public class OScriptManager {
    ...
    public OScriptManager() {
        ...
        executorsFactories.put(
                "javascript", (lang) -> useGraal ? new OPolyglotScriptExecutor(lang, new OScriptTransformerImpl())
                : new OJsr223ScriptExecutor(lang, new OScriptTransformerImpl())
        );
        executorsFactories.put(
                "ecmascript", (lang) ->  useGraal ?  new OPolyglotScriptExecutor(lang, new OScriptTransformerImpl())
                        : new OJsr223ScriptExecutor(lang, new OScriptTransformerImpl())
        );
