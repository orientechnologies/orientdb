...
public final class CellBTreeMultiValueV3NullBucketAddValuePO extends PageOperationRecord {
  private ORID rid;

  public CellBTreeMultiValueV3NullBucketAddValuePO() {
  }

  public CellBTreeMultiValueV3NullBucketAddValuePO(ORID rid) {
    this.rid = rid;
  }
  ...
  @Override
  public int getId() {
    return WALRecordTypes.CELL_BTREE_NULL_BUCKET_MULTI_VALUE_V3_ADD_VALUE_PO;
  }
