...
public class OEmbeddedRidBag_V1 implements OEmbeddedRidBag {
  ...
  private final class EntriesIterator implements Iterator<OIdentifiable>, OResettable, OSizeable {
    ...
    public void remove() {
      ...
      if (OEmbeddedRidBag_V1.this.owner != null)
        ORecordInternal.unTrack(OEmbeddedRidBag_V1.this.owner, nextValue);
  ...
  public Object returnOriginalState(List<OMultiValueChangeEvent<OIdentifiable, OIdentifiable>> multiValueChangeEvents) {
    final OEmbeddedRidBag_V1 reverted = new OEmbeddedRidBag_V1();
