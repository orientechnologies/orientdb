...
public final class CellBTreeMultiValueV3BucketRemoveNonLeafEntryPO extends PageOperationRecord {
  private int    index;
  private byte[] key;
  private int    left;
  private int    right;
  ...
  public CellBTreeMultiValueV3BucketRemoveNonLeafEntryPO() {
  }

  public CellBTreeMultiValueV3BucketRemoveNonLeafEntryPO(int index, byte[] key, int left, int right, int prevChild) {
    this.index = index;
    this.key = key;
    this.left = left;
    this.right = right;
  ...
  @Override
  public int getId() {
    return WALRecordTypes.CELL_BTREE_BUCKET_MULTI_VALUE_V3_REMOVE_NON_LEAF_ENTRY_PO;
  }
