...
public class PgmIndex<T> {
     ...
     */
    public PgmIndex(final int epsilon, final List<T> data) {
        ...
        this.build(data, epsilon != 0 ? epsilon : 64, epsilonRecursive, segments, levelsSizes, levelsOffset);
    }

    private void build(final List<T> data, long epsilon, long epsilonRecursive, List<Segment> segments, List<Long> levelsSizes, List<Long> levelsOffset) {
