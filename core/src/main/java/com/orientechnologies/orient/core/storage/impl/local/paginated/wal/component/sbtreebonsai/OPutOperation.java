...
public class OPutOperation extends OSBTreeBonsaiModificationOperation {
  private byte[] key;
  private byte[] value;
  ...
  public OPutOperation(OOperationUnitId operationUnitId, long fileId, OBonsaiBucketPointer pointer, byte[] key, byte[] value,
      byte[] oldValue) {
