...
public final class CellBTreeMultiValueV3BucketSetLeftSiblingPO extends PageOperationRecord {
  private long sibling;
  private long prevSibling;

  public CellBTreeMultiValueV3BucketSetLeftSiblingPO() {
  }

  public CellBTreeMultiValueV3BucketSetLeftSiblingPO(long sibling, long prevSibling) {
  ...
  @Override
  public int getId() {
    return WALRecordTypes.CELL_BTREE_BUCKET_MULTI_VALUE_V3_SET_LEFT_SIBLING_PO;
  }
