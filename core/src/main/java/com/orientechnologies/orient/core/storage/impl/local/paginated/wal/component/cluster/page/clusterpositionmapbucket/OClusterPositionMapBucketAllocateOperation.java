...
public class OClusterPositionMapBucketAllocateOperation extends OPageOperation {
  private int recordIndex;

  public OClusterPositionMapBucketAllocateOperation() {
  }

  public OClusterPositionMapBucketAllocateOperation(OLogSequenceNumber pageLSN, long fileId, long pageIndex, int recordIndex) {
  ...
  @Override
  public byte getId() {
    return WALRecordTypes.CLUSTER_POSITION_MAP_BUCKET_ALLOCATE_OPERATION;
  }
