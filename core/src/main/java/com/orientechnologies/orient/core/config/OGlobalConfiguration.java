...
public enum OGlobalConfiguration {
  ...
  MEMORY_LEFT_TO_OS("memory.leftToOS",
      "Amount of free memory which should be left unallocated in case of OrientDB is started outside of container. "
          ...
          + "Default value is 15%", String.class, "10%"),
  ...
  WAL_MAX_SEGMENT_SIZE("storage.wal.maxSegmentSize", "Maximum size of single WAL segment (in megabytes)", Integer.class, 4 * 1024),
