...
public enum OGlobalConfiguration {
  ...
  STORAGE_ENCRYPTION_METHOD("storage.encryptionMethod",
      "Record encryption method used in storage" + " Possible values : 'aes' and 'des'. Default is no encryption", String.class,
      "nothing"),
  ...
  // QUERY
      QUERY_PARALLEL_AUTO("query.parallelAuto", "Auto enable parallel query if requirement are met", Boolean.class,
