...
public class CellBTreeMultiValueV2BucketAppendNewLeafEntryPO extends PageOperationRecord {
  private int  index;
  private ORID value;
  ...
  public CellBTreeMultiValueV2BucketAppendNewLeafEntryPO(int index, ORID value) {
    this.index = index;
    this.value = value;
  }
  ...
  @Override
  public byte getId() {
    return WALRecordTypes.CELL_BTREE_BUCKET_MULTI_VALUE_V2_APPEND_NEW_LEAF_ENTRY_PO;
  }
