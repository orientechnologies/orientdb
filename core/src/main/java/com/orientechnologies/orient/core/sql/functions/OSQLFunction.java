...
public interface OSQLFunction {
   ...
   * {@linkplain #execute(com.orientechnologies.orient.core.db.record.OIdentifiable, java.lang.Object[], com.orientechnologies.orient.core.command.OCommandExecutor)
