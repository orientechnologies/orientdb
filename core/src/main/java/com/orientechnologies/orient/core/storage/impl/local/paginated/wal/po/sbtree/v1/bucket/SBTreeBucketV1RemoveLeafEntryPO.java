...
public final class SBTreeBucketV1RemoveLeafEntryPO extends PageOperationRecord {
  private int    index;
  private byte[] key;
  private byte[] value;

  public SBTreeBucketV1RemoveLeafEntryPO() {
  }

  public SBTreeBucketV1RemoveLeafEntryPO(int index, byte[] key, byte[] value) {
    this.index = index;
    this.key = key;
    this.value = value;
  }
  ...
  @Override
  public int getId() {
    return WALRecordTypes.SBTREE_BUCKET_V1_REMOVE_LEAF_ENTRY_PO;
  }
