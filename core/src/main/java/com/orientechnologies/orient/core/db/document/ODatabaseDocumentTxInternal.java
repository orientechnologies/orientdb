...
public class ODatabaseDocumentTxInternal {
  ...
  public static ODatabaseSessionMetadata getSessionMetadata(final ODatabaseDocumentTx db) {
    return db.sessionMetadata;
  }

  public static void setSessionMetadata(final ODatabaseDocumentTx db, final ODatabaseSessionMetadata sessionMetadata) {
