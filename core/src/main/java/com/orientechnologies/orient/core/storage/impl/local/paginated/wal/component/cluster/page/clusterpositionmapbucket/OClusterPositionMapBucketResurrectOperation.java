...
public class OClusterPositionMapBucketResurrectOperation extends OPageOperation {
  private int recordIndex;

  public OClusterPositionMapBucketResurrectOperation() {
  }

  public OClusterPositionMapBucketResurrectOperation(OLogSequenceNumber pageLSN, long fileId, long pageIndex, int recordIndex) {
  ...
  @Override
  public byte getId() {
    return WALRecordTypes.CLUSTER_POSITION_MAP_BUCKET_RESURRECT_OPERATION;
  }
