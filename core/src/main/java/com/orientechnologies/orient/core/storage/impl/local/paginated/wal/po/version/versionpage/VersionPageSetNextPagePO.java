...
public final class VersionPageSetNextPagePO extends PageOperationRecord {
  private int nextPage;
  private int oldNextPage;

  public VersionPageSetNextPagePO() {}

  public VersionPageSetNextPagePO(int nextPage, int oldNextPage) {
