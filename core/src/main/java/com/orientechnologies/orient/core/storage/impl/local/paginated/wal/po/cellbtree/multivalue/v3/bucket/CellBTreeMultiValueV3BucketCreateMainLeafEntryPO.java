...
public final class CellBTreeMultiValueV3BucketCreateMainLeafEntryPO extends PageOperationRecord {
  private int    index;
  private byte[] key;
  private ORID   value;
  private long   mId;

  public CellBTreeMultiValueV3BucketCreateMainLeafEntryPO() {
  }

  public CellBTreeMultiValueV3BucketCreateMainLeafEntryPO(int index, byte[] key, ORID value, long mId) {
    this.index = index;
    this.key = key;
    this.value = value;
    this.mId = mId;
  ...
  @Override
  public int getId() {
    return WALRecordTypes.CELL_BTREE_BUCKET_MULTI_VALUE_V3_CREATE_MAIN_LEAF_ENTRY_PO;
  }
