...
public class OCASWALPage {
   ...
   */
  public static int CRC32_OFFSET = 0;
   ...
   */
  public static int MAGIC_NUMBER_OFFSET = CRC32_OFFSET + OIntegerSerializer.INT_SIZE;

  public static final int PAGE_SIZE = 4 * 1024;

  public static final int RECORDS_OFFSET = MAGIC_NUMBER_OFFSET + OLongSerializer.LONG_SIZE;
