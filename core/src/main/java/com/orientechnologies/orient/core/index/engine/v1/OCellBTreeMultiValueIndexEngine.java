...
public final class OCellBTreeMultiValueIndexEngine implements OMultiValueIndexEngine, OCellBTreeIndexEngine {
  ...
  private final OCellBTree<OCompositeKey> singleValueTree;
  ...
  public OCellBTreeMultiValueIndexEngine(String name, OAbstractPaginatedStorage storage, final int version) {
    ...
    if (version == 1) {
      ...
      this.singleValueTree = new OCellBTreeSingleValueV3<>(name, DATA_FILE_EXTENSION, NULL_BUCKET_FILE_EXTENSION, storage);
  ...
  public boolean contains(Object key) {
    ...
    if (key != null) {
      final OCellBTree.OCellBTreeCursor<OCompositeKey, ORID> cursor = singleValueTree
  ...
  public void clear() {
    try {
      ...
      if (singleValueTree != null) {
        final OCellBTree.OCellBTreeKeyCursor<OCompositeKey> cursor = singleValueTree.keyCursor();
  ...
  public OIndexKeyCursor keyCursor() {
    ...
    return new OIndexKeyCursor() {
      private final OCellBTree.OCellBTreeKeyCursor<OCompositeKey> keyCursor = singleValueTree.keyCursor();
  ...
  private static final class OMCellBTreeIndexCursor extends OIndexAbstractCursor {
    private final OCellBTree.OCellBTreeCursor<OCompositeKey, ORID> treeCursor;

    private OMCellBTreeIndexCursor(OCellBTree.OCellBTreeCursor<OCompositeKey, ORID> treeCursor) {
      this.treeCursor = treeCursor;
    }
