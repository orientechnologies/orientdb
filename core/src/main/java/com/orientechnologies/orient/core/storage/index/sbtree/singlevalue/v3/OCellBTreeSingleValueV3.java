...
public final class OCellBTreeSingleValueV3<K> extends ODurableComponent implements OCellBTree<K> {
  ...
  public void create(final OBinarySerializer<K> keySerializer, final OType[] keyTypes, final int keySize,
    ...
    try {
      ...
      try {
        ...
        try {
          final OEntryPointV3<K> entryPoint = new OEntryPointV3<>(entryPointCacheEntry);
          entryPoint.init();
        } finally {
        ...
        try {
          ...
          final OCellBTreeBucketV3<K> rootBucket = new OCellBTreeBucketV3<>(rootCacheEntry, true, keySerializer, keyTypes,
              encryption);
        } finally {
        ...
        try {
          @SuppressWarnings("unused")
          final ONullBucketV3 nullBucket = new ONullBucketV3(nullCacheEntry, true);
        } finally {
    ...
    try {
      ...
      try {
        ...
        if (key != null) {
          ...
          try {
            final OCellBTreeBucketV3<K> keyBucket = new OCellBTreeBucketV3<>(keyBucketCacheEntry, keySerializer, keyTypes,
                encryption);
          ...
          try {
            final ONullBucketV3 nullBucket = new ONullBucketV3(nullBucketCacheEntry, false);
      ...
      throw OException
          .wrapException(new OCellBTreeSingleValueExceptionV3("Error during retrieving  of sbtree with name " + getName(), this),
              e);
    } finally {
      ...
      try {
        if (key != null) {
          ...
          OCacheEntry keyBucketCacheEntry = loadPageForWrite(atomicOperation, fileId, bucketSearchResult.getLastPathItem(), false,
              true);
          OCellBTreeBucketV3<K> keyBucket = new OCellBTreeBucketV3<>(keyBucketCacheEntry, keySerializer, keyTypes, encryption);
          ...
          if (encryption == null) {
            ...
            rawKey = encryption.encrypt(serializedKey);
          }
          ...
          while (!keyBucket.addLeafEntry(insertionIndex, rawKey, serializedValue)) {
            ...
            keyBucket = new OCellBTreeBucketV3<>(keyBucketCacheEntry, keySerializer, keyTypes, encryption);
          }
          ...
          try {
            final ONullBucketV3 nullBucket = new ONullBucketV3(cacheEntry, false);
  ...
  public void clear() throws IOException {
    ...
    try {
      ...
      try {
        ...
        try {
          final ONullBucketV3 nullBucket = new ONullBucketV3(nullCacheEntry, false);
        ...
        try {
          @SuppressWarnings("unused")
          final OCellBTreeBucketV3<K> rootBucket = new OCellBTreeBucketV3<>(cacheEntry, true, keySerializer, keyTypes, encryption);
        } finally {
          releasePageFromWrite(atomicOperation, cacheEntry);
        }
      } finally {
  ...
  public void load(final String name, final int keySize, final OType[] keyTypes, final OBinarySerializer<K> keySerializer,
    ...
    try {
      ...
      throw OException.wrapException(new OCellBTreeSingleValueExceptionV3("Exception during loading of sbtree " + name, this), e);
    } finally {
      releaseExclusiveLock();
    }
  }
  ...
  public long size() {
    ...
    try {
      ...
      throw OException
          .wrapException(new OCellBTreeSingleValueExceptionV3("Error during retrieving of size of index " + getName(), this), e);
    } finally {
      atomicOperationsManager.releaseReadLock(this);
    }
  }
  ...
  private ORID removeKey(final OAtomicOperation atomicOperation, final BucketSearchResult bucketSearchResult) throws IOException {
    ...
    try {
      final OCellBTreeBucketV3<K> keyBucket = new OCellBTreeBucketV3<>(keyBucketCacheEntry, keySerializer, keyTypes, encryption);
  ...
  public K firstKey() {
    ...
    try {
      ...
      try {
        ...
        try {
          final OCellBTreeBucketV3<K> bucket = new OCellBTreeBucketV3<>(cacheEntry, keySerializer, keyTypes, encryption);
      ...
      throw OException
          .wrapException(new OCellBTreeSingleValueExceptionV3("Error during finding first key in sbtree [" + getName() + "]", this),
              e);
    } finally {
      atomicOperationsManager.releaseReadLock(this);
    }
  ...
  public K lastKey() {
    ...
    try {
      ...
      throw OException
          .wrapException(new OCellBTreeSingleValueExceptionV3("Error during finding last key in sbtree [" + getName() + "]", this),
              e);
    } finally {
      atomicOperationsManager.releaseReadLock(this);
    }
  ...
  private BucketSearchResult firstItem(final OAtomicOperation atomicOperation) throws IOException {
    ...
    int itemIndex = 0;
    try {
      OCellBTreeBucketV3<K> bucket = new OCellBTreeBucketV3<>(cacheEntry, keySerializer, keyTypes, encryption);
      ...
      while (true) {
        ...
        bucket = new OCellBTreeBucketV3<>(cacheEntry, keySerializer, keyTypes, encryption);
      }
    } finally {
      releasePageFromRead(atomicOperation, cacheEntry);
    }
      ...
      while (true) {
        if (!bucket.isLeaf()) {
          if (itemIndex < -1) {
            ...
            itemIndex = OCellBTreeBucketV3.MAX_PAGE_SIZE_BYTES + 1;
          }
        } else {
          if (bucket.isEmpty()) {
            if (!path.isEmpty()) {
        ...
        bucket = new OCellBTreeBucketV3<>(cacheEntry, keySerializer, keyTypes, encryption);
        if (itemIndex == OCellBTreeBucketV3.MAX_PAGE_SIZE_BYTES + 1) {
  ...
  private UpdateBucketSearchResult splitBucket(final OCellBTreeBucketV3<K> bucketToSplit, final OCacheEntry entryToSplit,
  ...
  private UpdateBucketSearchResult splitNonRootBucket(final List<Long> path, final List<Integer> itemPointers, final int keyIndex,
      final long pageIndex, final OCellBTreeBucketV3<K> bucketToSplit, final boolean splitLeaf, final int indexToSplit,
    ...
    try {
      final OCellBTreeBucketV3<K> newRightBucket = new OCellBTreeBucketV3<>(rightBucketEntry, splitLeaf, keySerializer, keyTypes,
          encryption);
      ...
      if (splitLeaf) {
        ...
        if (rightSiblingPageIndex >= 0) {
          ...
          final OCellBTreeBucketV3<K> rightSiblingBucket = new OCellBTreeBucketV3<>(rightSiblingBucketEntry, keySerializer,
              keyTypes, encryption);
          try {
      ...
      try {
        OCellBTreeBucketV3<K> parentBucket = new OCellBTreeBucketV3<>(parentCacheEntry, keySerializer, keyTypes, encryption);
        final OCellBTreeBucketV3.SBTreeEntry<K> parentEntry = new OCellBTreeBucketV3.SBTreeEntry<>((int) pageIndex,
        ...
        while (!parentBucket.addEntry(insertionIndex, parentEntry, true)) {
          ...
          parentBucket = new OCellBTreeBucketV3<>(parentCacheEntry, keySerializer, keyTypes, encryption);
        }
  ...
  private UpdateBucketSearchResult splitRootBucket(final int keyIndex, final OCacheEntry bucketEntry,
      OCellBTreeBucketV3<K> bucketToSplit, final boolean splitLeaf, final int indexToSplit, final K separationKey,
    ...
    try {
      final OCellBTreeBucketV3<K> newLeftBucket = new OCellBTreeBucketV3<>(leftBucketEntry, splitLeaf, keySerializer, keyTypes,
          encryption);
    ...
    bucketToSplit = new OCellBTreeBucketV3<>(bucketEntry, false, keySerializer, keyTypes, encryption);
    bucketToSplit.addEntry(0,
        new OCellBTreeBucketV3.SBTreeEntry<>((int) leftBucketEntry.getPageIndex(), (int) rightBucketEntry.getPageIndex(),
  ...
  private BucketSearchResult findBucket(final K key, final OAtomicOperation atomicOperation) throws IOException {
    ...
    while (true) {
      ...
      if (depth > MAX_PATH_LENGTH) {
        throw new OCellBTreeSingleValueExceptionV3(
      ...
      try {
        final OCellBTreeBucketV3<K> keyBucket = new OCellBTreeBucketV3<>(bucketEntry, keySerializer, keyTypes, encryption);
  ...
  private Map.Entry<K, ORID> convertToMapEntry(final OCellBTreeBucketV3.SBTreeEntry<K> treeEntry) {
  ...
  public final class OCellBTreeFullKeyCursor implements OCellBTreeKeyCursor<K> {
    ...
    public K next(int prefetchSize) {
      ...
      atomicOperationsManager.acquireReadLock(OCellBTreeSingleValueV3.this);
      try {
        acquireSharedLock();
        try {
          final OAtomicOperation atomicOperation = OAtomicOperationsManager.getCurrentOperation();
        ...
        throw OException
            .wrapException(new OCellBTreeSingleValueExceptionV3("Error during element iteration", OCellBTreeSingleValueV3.this), e);
      } finally {
        atomicOperationsManager.releaseReadLock(OCellBTreeSingleValueV3.this);
      }
