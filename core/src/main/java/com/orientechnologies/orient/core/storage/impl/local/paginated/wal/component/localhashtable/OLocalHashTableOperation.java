...
public abstract class OLocalHashTableOperation extends OComponentOperation {
  private String name;
  ...
  public void rollback(OAbstractPaginatedStorage storage, OAtomicOperation atomicOperation) {
    storage.rollbackHashTableOperation(this, atomicOperation);
  }

  public abstract void rollbackOperation(OLocalHashTableV2 hashTable, OAtomicOperation atomicOperation);
