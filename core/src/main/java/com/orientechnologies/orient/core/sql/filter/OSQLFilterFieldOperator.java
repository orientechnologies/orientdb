...
public enum OSQLFilterFieldOperator {
  FIELD(-2, "FIELD"), SIZE(0, "SIZE"), LENGTH(1, "LENGTH"), TOUPPERCASE(2, "TOUPPERCASE"), TOLOWERCASE(3, "TOLOWERCASE"), TRIM(4,
      ...
      14, "ASINTEGER"), ASLONG(15, "ASLONG"), ASFLOAT(16, "ASFLOAT"), ASDECIMAL(17, "ASDECIMAL"), ASDATE(18, "ASDATE"), ASDATETIME(
      19, "ASDATETIME"), ASBOOLEAN(20, "ASBOOLEAN"), TOJSON(21, "TOJSON"), KEYS(22, "KEYS"), VALUES(23, "VALUES"), REPLACE(24,
      "REPLACE", 2), NORMALIZE(25, "NORMALIZE", 0, 2);

  protected static final OSQLFilterFieldOperator[] OPERATORS       = { FIELD, SIZE, LENGTH, TOUPPERCASE, TOLOWERCASE, TRIM, LEFT,
      RIGHT, SUBSTRING, CHARAT, INDEXOF, FORMAT, APPEND, PREFIX, ASSTRING, ASINTEGER, ASLONG, ASFLOAT, ASDECIMAL, ASDATE,
      ASDATETIME, ASBOOLEAN, TOJSON, KEYS, VALUES, REPLACE, NORMALIZE };
