...
public enum OSQLFilterFieldOperator {
	FIELD(-2, "FIELD"), ATTRIB(-1, "ATTRIB"), SIZE(0, "SIZE"), LENGTH(1, "LENGTH"), TOUPPERCASE(2, "TOUPPERCASE"), TOLOWERCASE(3,
			"TOLOWERCASE"), TRIM(4, "TRIM"), LEFT(5, "LEFT", 1), RIGHT(6, "RIGHT", 1), SUBSTRING(7, "SUBSTRING", 1, 2), CHARAT(8,
			"CHARAT", 1), INDEXOF(9, "INDEXOF", 1, 2), FORMAT(10, "FORMAT", 1), APPEND(11, "APPEND", 1), PREFIX(12, "PREFIX", 1), ASSTRING(
			13, "ASSTRING"), ASINTEGER(14, "ASINTEGER"), ASFLOAT(15, "ASFLOAT"), ASDATE(16, "ASDATE"), ASDATETIME(17, "ASDATETIME"), ASBOOLEAN(
			18, "ASBOOLEAN"), TOJSON(19, "TOJSON"), KEYS(20, "KEYS"), VALUES(21, "VALUES");
