...
public interface ODatabase<T> extends OBackupable, Closeable, OUserObject2RecordHandler {
  ...
  public void freezeCluster(int iClusterId, boolean throwException);
	 ...
	 *
	 * @param iObject
	 *          The object passed change based on the Database implementation: records for {@link com.orientechnologies.orient.core.db.record.ODatabaseRecord} implementations and
	 *          POJO for {@link com.orientechnologies.orient.core.db.object.ODatabaseObject} implementations.
	 ...
	 * @see com.orientechnologies.orient.core.db.record.ODatabaseRecord#setMVCC(boolean)
	 */
	 ...
	 *
	 * @param iValue
	 * @see com.orientechnologies.orient.core.db.record.ODatabaseRecord#isMVCC()
	 * @return The Database instance itself giving a "fluent interface". Useful to call multiple methods in chain.
	 */
