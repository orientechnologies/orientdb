...
Token token;
 ...
 /*@bgen(jjtree) SecurityResourceSegment */
  ...
  private int jj_la;
  private int jj_gen;
  final private int[] jj_la1 = new int[427];
  ...
  public OrientSql(CharStream stream) {
    ...
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 427; i++) jj_la1[i] = -1;
...
/** Get the specific Token. */
  ...
  public ParseException generateParseException() {
    jj_expentries.clear();
    boolean[] la1tokens = new boolean[280];
    if (jj_kind >= 0) {
