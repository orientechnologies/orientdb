...
Token token;
 ...
 /*@bgen(jjtree) ForEachBlock */
  ...
  private boolean jj_3R_899() {
    ...
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_910()) { jj_scanpos = xsp; break; }
    }
    xsp = jj_scanpos;
  ...
  private boolean jj_3R_898() {
    ...
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_908()) { jj_scanpos = xsp; break; }
    }
    xsp = jj_scanpos;
  ...
  private boolean jj_3R_645() {
    ...
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_886()) { jj_scanpos = xsp; break; }
    }
    return false;
  }
  ...
  private int jj_la;
  private int jj_gen;
  final private int[] jj_la1 = new int[388];
  ...
  public OrientSql(CharStream stream) {
    ...
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 388; i++) jj_la1[i] = -1;
