...
Token token;
 ...
 /*@bgen(jjtree) ForEachBlock */
  ...
  private int jj_la;
  private int jj_gen;
  final private int[] jj_la1 = new int[358];
  ...
  public OrientSql(CharStream stream) {
    ...
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 358; i++) jj_la1[i] = -1;
