...
Token token;
 ...
 /*@bgen(jjtree) CreateSecurityPolicyStatement */
  ...
  private boolean jj_3R_978() {
    ...
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_1013()) { jj_scanpos = xsp; break; }
    }
  ...
  private boolean jj_3R_976() {
    ...
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_1009()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(RBRACE)) return true;
    xsp = jj_scanpos;
  ...
  private boolean jj_3R_964() {
    ...
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_1006()) { jj_scanpos = xsp; break; }
    }
    xsp = jj_scanpos;
  ...
  private int jj_la;
  private int jj_gen;
  final private int[] jj_la1 = new int[431];
