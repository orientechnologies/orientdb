...
Token token;
 ...
 /*@bgen(jjtree) WhileBlock */
  ...
  private int jj_la;
  private int jj_gen;
  final private int[] jj_la1 = new int[421];
  ...
  public OrientSql(CharStream stream) {
    ...
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 421; i++) jj_la1[i] = -1;
