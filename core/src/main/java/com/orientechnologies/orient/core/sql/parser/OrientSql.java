...
//    }
 ...
 /*@bgen(jjtree) ReturnStatement */
  ...
  public OrientSql(CharStream stream) {
    ...
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 345; i++) jj_la1[i] = -1;
