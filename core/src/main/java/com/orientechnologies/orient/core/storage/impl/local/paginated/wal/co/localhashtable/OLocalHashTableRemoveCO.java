...
public class OLocalHashTableRemoveCO extends OAbstractIndexCO {
  private byte[] value;
  private byte   valueSerializerId;

  public OLocalHashTableRemoveCO() {
  }

  public OLocalHashTableRemoveCO(final int indexId, final String encryptionName, final byte keySerializerId, final byte[] key,
