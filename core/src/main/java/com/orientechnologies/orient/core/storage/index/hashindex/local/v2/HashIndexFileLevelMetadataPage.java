 ...
 * @since 5/8/14
 */
public final class HashIndexFileLevelMetadataPage extends ODurablePage {
  ...
  HashIndexFileLevelMetadataPage(OCacheEntry cacheEntry, boolean isNewPage) {
    super(cacheEntry);

    if (isNewPage) {
      for (int i = 0; i < LocalHashTableV2.HASH_CODE_SIZE; i++)
        remove(i);
