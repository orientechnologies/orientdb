...
public final class CellBTreeBucketSingleValueV3RemoveLeafEntryPO extends PageOperationRecord {
  private int    index;
  private byte[] key;
  private byte[] value;

  public CellBTreeBucketSingleValueV3RemoveLeafEntryPO() {
  }

  public CellBTreeBucketSingleValueV3RemoveLeafEntryPO(int index, byte[] key, byte[] value) {
    this.index = index;
    this.key = key;
    this.value = value;
  }
