...
public final class LocalHashTableV2BucketAddEntryPO extends PageOperationRecord {
  ...
  public LocalHashTableV2BucketAddEntryPO(int index, long hashCode, byte[] key, byte[] value) {
    this.index = index;
  ...
  public void redo(OCacheEntry cacheEntry) {
    ...
    if (!bucket.addEntry(index, hashCode, key, value)) {
  ...
  @Override
  public int getId() {
    return WALRecordTypes.LOCAL_HASH_TABLE_V2_BUCKET_ADD_ENTRY_PO;
  }
