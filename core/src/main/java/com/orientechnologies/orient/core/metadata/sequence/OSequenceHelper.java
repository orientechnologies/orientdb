...
public class OSequenceHelper {
  ...
  public static OSequence createSequenceOnLocal(OSequenceLibrary sequenceLibary, String sequenceName, SEQUENCE_TYPE sequenceType, OSequence.CreateParams params) {
    if (sequenceLibary instanceof OSequenceLibraryAbstract){
