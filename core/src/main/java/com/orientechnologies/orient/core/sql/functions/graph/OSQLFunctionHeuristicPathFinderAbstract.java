...
public abstract class OSQLFunctionHeuristicPathFinderAbstract extends OSQLFunctionMathAbstract {
    ...
    protected abstract double getHeuristicCost(final OVertex node, final OVertex parent, final OVertex target, OCommandContext iContext);
    ...
    protected double getCustomHeuristicCost(final String functionName, final String[] vertextAxisNames, final OVertex start, final OVertex goal, final OVertex current, final OVertex parent, final long depth, double dFactor, OCommandContext ctx) {
