...
public class ODocumentHelper {
	 ...
	 * @see #equals(Object);
	 */
	public static boolean hasSameContentOf(final ODocument iCurrent, final ODatabaseRecord iMyDb,
																				 final ODocument iOther, final ODatabaseRecord iOtherDb) {
		if (iOther == null)
			return false;
					...
					if (!hasSameContentOf(makeDbCall(iMyDb, new ODbRelatedCall<ODocument>() {
						public ODocument call() {
							return (ODocument) myEntry.getValue();
									...
									makeDbCall(iOtherDb, new ODbRelatedCall<ODocument>() {
										public ODocument call() {
