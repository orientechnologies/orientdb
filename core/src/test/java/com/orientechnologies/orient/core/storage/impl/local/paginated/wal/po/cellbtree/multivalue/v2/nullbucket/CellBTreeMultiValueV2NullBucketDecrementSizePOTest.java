...
public class CellBTreeMultiValueV2NullBucketDecrementSizePOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(
          operations.get(0) instanceof CellBTreeMultiValueV2NullBucketDecrementSizePO);

      final CellBTreeMultiValueV2NullBucketDecrementSizePO pageOperation =
          (CellBTreeMultiValueV2NullBucketDecrementSizePO) operations.get(0);
