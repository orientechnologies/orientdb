...
public class CellBTreeMultiValueV3BucketShrinkNonLeafEntriesPOTest {
  @Test
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(operations.get(0) instanceof CellBTreeMultiValueV3BucketShrinkNonLeafEntriesPO);

      final CellBTreeMultiValueV3BucketShrinkNonLeafEntriesPO pageOperation = (CellBTreeMultiValueV3BucketShrinkNonLeafEntriesPO) operations
          .get(0);
  ...
  public void testSerialization() {
    ...
    CellBTreeMultiValueV3BucketShrinkNonLeafEntriesPO operation = new CellBTreeMultiValueV3BucketShrinkNonLeafEntriesPO(12,
    ...
    CellBTreeMultiValueV3BucketShrinkNonLeafEntriesPO restoredOperation = new CellBTreeMultiValueV3BucketShrinkNonLeafEntriesPO();
    ...
    final List<CellBTreeMultiValueV3Bucket.NonLeafEntry> restoredLeafEntries = restoredOperation.getRemovedEntries();
