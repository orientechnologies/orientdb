...
public class SBTreeBucketV1RemoveNonLeafEntryPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final SBTreeBucketV1RemoveNonLeafEntryPO pageOperation = (SBTreeBucketV1RemoveNonLeafEntryPO) operations.get(0);
      ...
      Assert.assertEquals(new OSBTreeBucketV1.SBTreeEntry<>(1, 3, (byte) 0, null),
          restoredBucket.getEntry(0, null, OByteSerializer.INSTANCE, OLinkSerializer.INSTANCE));
      Assert.assertEquals(new OSBTreeBucketV1.SBTreeEntry<>(3, 4, (byte) 2, null),
          restoredBucket.getEntry(1, null, OByteSerializer.INSTANCE, OLinkSerializer.INSTANCE));
  ...
  public void testSerialization() {
    SBTreeBucketV1RemoveNonLeafEntryPO operation = new SBTreeBucketV1RemoveNonLeafEntryPO(12, 21, new byte[] { 4, 2 }, 42, 24);
