...
public class CellBTreeMultiValueV3BucketCreateMainLeafEntryPOTest {
  @Test
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(operations.get(0) instanceof CellBTreeMultiValueV3BucketCreateMainLeafEntryPO);

      final CellBTreeMultiValueV3BucketCreateMainLeafEntryPO pageOperation = (CellBTreeMultiValueV3BucketCreateMainLeafEntryPO) operations
          .get(0);
  ...
  public void testSerialization() {
    ...
    CellBTreeMultiValueV3BucketCreateMainLeafEntryPO operation = new CellBTreeMultiValueV3BucketCreateMainLeafEntryPO(1,
    ...
    CellBTreeMultiValueV3BucketCreateMainLeafEntryPO restoredOperation = new CellBTreeMultiValueV3BucketCreateMainLeafEntryPO();
