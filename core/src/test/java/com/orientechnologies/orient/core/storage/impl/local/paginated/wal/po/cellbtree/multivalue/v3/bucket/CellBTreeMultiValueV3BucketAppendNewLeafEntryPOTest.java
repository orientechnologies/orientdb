...
public class CellBTreeMultiValueV3BucketAppendNewLeafEntryPOTest {
  @Test
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(operations.get(0) instanceof CellBTreeMultiValueV3BucketAppendNewLeafEntryPO);

      final CellBTreeMultiValueV3BucketAppendNewLeafEntryPO pageOperation = (CellBTreeMultiValueV3BucketAppendNewLeafEntryPO) operations
          .get(0);
  ...
  public void testSerialization() {
    ...
    CellBTreeMultiValueV3BucketAppendNewLeafEntryPO operation = new CellBTreeMultiValueV3BucketAppendNewLeafEntryPO(1,
        new ORecordId(5, 5));
    ...
    CellBTreeMultiValueV3BucketAppendNewLeafEntryPO restoredOperation = new CellBTreeMultiValueV3BucketAppendNewLeafEntryPO();
