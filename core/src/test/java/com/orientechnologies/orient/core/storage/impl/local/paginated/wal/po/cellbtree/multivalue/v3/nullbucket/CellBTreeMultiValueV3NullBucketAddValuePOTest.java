...
public class CellBTreeMultiValueV3NullBucketAddValuePOTest {
  @Test
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(operations.get(0) instanceof CellBTreeMultiValueV3NullBucketAddValuePO);

      final CellBTreeMultiValueV3NullBucketAddValuePO pageOperation = (CellBTreeMultiValueV3NullBucketAddValuePO) operations.get(0);
  ...
  public void testSerialization() {
    ...
    CellBTreeMultiValueV3NullBucketAddValuePO operation = new CellBTreeMultiValueV3NullBucketAddValuePO(new ORecordId(12, 34));
    ...
    CellBTreeMultiValueV3NullBucketAddValuePO restoredOperation = new CellBTreeMultiValueV3NullBucketAddValuePO();
