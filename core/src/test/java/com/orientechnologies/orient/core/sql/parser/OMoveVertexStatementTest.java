...
public class OMoveVertexStatementTest extends OParserTestAbstract{
  ...
  public void test() {
    ...
    checkRightSyntax("move vertex (select from V) to class:newposition set name = 'a', surname = 'b'");
    checkRightSyntax("move vertex (select from V) to class:newposition set name = 'a', surname = 'b' batch 1000");
