...
public class SBTreeBucketV1AddNonLeafEntryPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final SBTreeBucketV1AddNonLeafEntryPO pageOperation =
          (SBTreeBucketV1AddNonLeafEntryPO) operations.get(0);
      ...
      Assert.assertEquals(
          new OSBTreeBucketV1.SBTreeEntry<>(2, 4, (byte) 2, null),
  ...
  public void testSerialization() {
    SBTreeBucketV1AddNonLeafEntryPO operation =
        new SBTreeBucketV1AddNonLeafEntryPO(12, new byte[] {4, 2}, true, 12, 45, 67);
