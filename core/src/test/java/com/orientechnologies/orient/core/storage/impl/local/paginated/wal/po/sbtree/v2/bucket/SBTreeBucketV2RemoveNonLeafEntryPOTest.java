...
public class SBTreeBucketV2RemoveNonLeafEntryPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final SBTreeBucketV2RemoveNonLeafEntryPO pageOperation =
          (SBTreeBucketV2RemoveNonLeafEntryPO) operations.get(0);
      ...
      Assert.assertEquals(
          new OSBTreeBucketV2.SBTreeEntry<>(1, 3, (byte) 0, null),
          restoredBucket.getEntry(0, OByteSerializer.INSTANCE, OLinkSerializer.INSTANCE));
      Assert.assertEquals(
          new OSBTreeBucketV2.SBTreeEntry<>(3, 4, (byte) 2, null),
          restoredBucket.getEntry(1, OByteSerializer.INSTANCE, OLinkSerializer.INSTANCE));
  ...
  public void testSerialization() {
    SBTreeBucketV2RemoveNonLeafEntryPO operation =
        new SBTreeBucketV2RemoveNonLeafEntryPO(12, 21, new byte[] {4, 2}, 42, 24);
