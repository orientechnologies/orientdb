...
public class CellBTreeBucketSingleValueV3RemoveLeafEntryPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final CellBTreeBucketSingleValueV3RemoveLeafEntryPO pageOperation =
          (CellBTreeBucketSingleValueV3RemoveLeafEntryPO) operations.get(0);
      ...
      Assert.assertEquals(
          new ORecordId(0, 0), restoredBucket.getValue(0, OByteSerializer.INSTANCE));
      Assert.assertEquals(
          new ORecordId(2, 2), restoredBucket.getValue(1, OByteSerializer.INSTANCE));
  ...
  public void testSerialization() {
    CellBTreeBucketSingleValueV3RemoveLeafEntryPO operation =
        new CellBTreeBucketSingleValueV3RemoveLeafEntryPO(1, new byte[] {2, 4}, new byte[] {4, 2});
    ...
    CellBTreeBucketSingleValueV3RemoveLeafEntryPO restoredOperation =
        new CellBTreeBucketSingleValueV3RemoveLeafEntryPO();
