...
public class CellBTreeMultiValueV2NullBucketRemoveValuePOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final CellBTreeMultiValueV2NullBucketRemoveValuePO pageOperation =
          (CellBTreeMultiValueV2NullBucketRemoveValuePO) operations.get(0);
  ...
  public void testSerialization() {
    CellBTreeMultiValueV2NullBucketRemoveValuePO operation =
        new CellBTreeMultiValueV2NullBucketRemoveValuePO(new ORecordId(12, 34));
    ...
    CellBTreeMultiValueV2NullBucketRemoveValuePO restoredOperation =
