...
public class JSScriptTest {
    ...
    public void jsSandboxTestWithJavaType() {
        ...
        try {
            ...
            final OResultSet result = db.execute("javascript", "var File = Java.type(\"java.io.File\");\n  File.pathSeparator;");
    ...
    public void jsSandboxWithNativeTest() {
        ...
        try {
            ...
            OResultSet resultSet =
                    db.execute("javascript", "var System = Java.type('java.lang.System'); System.nanoTime();");
            ...
            scriptManager.removeAllowedPackages(
                    new HashSet<>(Arrays.asList("java.lang.System")));
    ...
    public void jsSandboxWithBigDecimal() {
        ...
        try (ODatabaseDocument db = orientDB.open(name.getMethodName(), "admin", "admin")) {
            ...
            try (OResultSet resultSet = db.execute("javascript", "var BigDecimal = Java.type('java.math.BigDecimal'); new BigDecimal(1.0);")) {
                Assert.assertEquals(1, resultSet.stream().count());
            }
