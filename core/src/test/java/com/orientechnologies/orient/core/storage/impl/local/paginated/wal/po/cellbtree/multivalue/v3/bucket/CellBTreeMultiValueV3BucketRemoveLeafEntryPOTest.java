...
public class CellBTreeMultiValueV3BucketRemoveLeafEntryPOTest {
  @Test
  public void testRedoMainEntry() {
    ...
    try {
      ...
      Assert.assertTrue(operations.get(0) instanceof CellBTreeMultiValueV3BucketRemoveLeafEntryPO);

      final CellBTreeMultiValueV3BucketRemoveLeafEntryPO pageOperation = (CellBTreeMultiValueV3BucketRemoveLeafEntryPO) operations
          .get(0);
  ...
  public void testRedoMainSeveralEntries() {
    ...
    try {
      ...
      final CellBTreeMultiValueV3Bucket.LeafEntry addLeafEntry = new CellBTreeMultiValueV3Bucket.LeafEntry(new byte[] { 4 }, 4,
          Arrays.asList(new ORecordId[] { new ORecordId(4, 4), new ORecordId(5, 5), new ORecordId(6, 6) }), 3);

      bucket.addAll(Collections.singletonList(addLeafEntry), OByteSerializer.INSTANCE);
  ...
  public void testSerialization() {
    ...
    CellBTreeMultiValueV3BucketRemoveLeafEntryPO operation = new CellBTreeMultiValueV3BucketRemoveLeafEntryPO(1,
        new ORecordId(5, 5));
    ...
    CellBTreeMultiValueV3BucketRemoveLeafEntryPO restoredOperation = new CellBTreeMultiValueV3BucketRemoveLeafEntryPO();
