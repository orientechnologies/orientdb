...
public class OBatchScriptTest {
  ...
  public void testPlain() {
    ...
    String s =
        "" + "begin;" + "let $a = select from foo let a = 13 where bar = 'baz';" + "let $b = insert into foo set name = 'baz';"
            + "let $c = update v set name = 'lkajsd';" + "if($c < $a){" + "   update v set surname = baz;" + "   if($c < $b){"
            + "       return 0;" + "   }" + "}" + "return 1;";
