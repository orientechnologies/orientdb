...
public class VersionPageDeleteRecordPOTest {
  @Test
  public void testRedo() {
    ...
    try {
      ...
      versionPage.deleteRecord(1, true);

      final List<PageOperationRecord> operations = entry.getPageOperations();
      Assert.assertEquals(1, operations.size());

      Assert.assertTrue(operations.get(0) instanceof VersionPageDeleteRecordPO);

      final VersionPageDeleteRecordPO pageOperation = (VersionPageDeleteRecordPO) operations.get(0);
  ...
  public void testSerialization() {
    VersionPageDeleteRecordPO operation =
        new VersionPageDeleteRecordPO(34, 12, new byte[] {4, 2}, true);
    ...
    VersionPageDeleteRecordPO restoredOperation = new VersionPageDeleteRecordPO();
