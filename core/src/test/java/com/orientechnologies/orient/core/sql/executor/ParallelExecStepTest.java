...
public class ParallelExecStepTest {
  ...
  @Test public void test() {
    ...
    for (int i = 0; i < 4; i++) {
      FetchFromRidsStep step0 = new FetchFromRidsStep(Collections.singleton(new ORecordId(12, i)), ctx);
      FetchFromRidsStep step1 = new FetchFromRidsStep(Collections.singleton(new ORecordId(12, i)), ctx);
