...
public class CellBTreeMultiValueV3BucketShrinkLeafEntriesPOTest {
  @Test
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(operations.get(0) instanceof CellBTreeMultiValueV3BucketShrinkLeafEntriesPO);

      final CellBTreeMultiValueV3BucketShrinkLeafEntriesPO pageOperation = (CellBTreeMultiValueV3BucketShrinkLeafEntriesPO) operations
          .get(0);
  ...
  public void testSerialization() {
    ...
    CellBTreeMultiValueV3BucketShrinkLeafEntriesPO operation = new CellBTreeMultiValueV3BucketShrinkLeafEntriesPO(3, leafEntries,
    ...
    CellBTreeMultiValueV3BucketShrinkLeafEntriesPO restoredOperation = new CellBTreeMultiValueV3BucketShrinkLeafEntriesPO();
    ...
    final List<CellBTreeMultiValueV3Bucket.LeafEntry> restoredLeafEntries = restoredOperation.getRemovedEntries();
