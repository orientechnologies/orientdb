...
public class PaginatedClusterStateV0SetRecordsSizePOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final PaginatedClusterStateV0SetRecordsSizePO pageOperation =
          (PaginatedClusterStateV0SetRecordsSizePO) operations.get(0);
  ...
  public void testSerialization() {
    PaginatedClusterStateV0SetRecordsSizePO operation =
        new PaginatedClusterStateV0SetRecordsSizePO(12, 42);
    ...
    PaginatedClusterStateV0SetRecordsSizePO restoredOperation =
        new PaginatedClusterStateV0SetRecordsSizePO();
