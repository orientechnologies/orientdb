...
public class PaginatedClusterStateV2SetRecordsSizePOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final PaginatedClusterStateV2SetRecordsSizePO pageOperation =
          (PaginatedClusterStateV2SetRecordsSizePO) operations.get(0);
  ...
  public void testSerialization() {
    PaginatedClusterStateV2SetRecordsSizePO operation =
        new PaginatedClusterStateV2SetRecordsSizePO(12, 42);
    ...
    PaginatedClusterStateV2SetRecordsSizePO restoredOperation =
        new PaginatedClusterStateV2SetRecordsSizePO();
