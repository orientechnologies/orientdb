...
public class CellBTreeMultiValueV3BucketDecrementEntriesCountPOTest {
  @Test
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(operations.get(0) instanceof CellBTreeMultiValueV3BucketDecrementEntriesCountPO);

      final CellBTreeMultiValueV3BucketDecrementEntriesCountPO pageOperation = (CellBTreeMultiValueV3BucketDecrementEntriesCountPO) operations
          .get(0);
  ...
  public void testSerialization() {
    ...
    CellBTreeMultiValueV3BucketDecrementEntriesCountPO operation = new CellBTreeMultiValueV3BucketDecrementEntriesCountPO(42);
    ...
    CellBTreeMultiValueV3BucketDecrementEntriesCountPO restoredOperation = new CellBTreeMultiValueV3BucketDecrementEntriesCountPO();
