...
public class SBTreeBucketV2AddLeafEntryPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final SBTreeBucketV2AddLeafEntryPO pageOperation = (SBTreeBucketV2AddLeafEntryPO) operations.get(0);
  ...
  public void testSerialization() {
    SBTreeBucketV2AddLeafEntryPO operation = new SBTreeBucketV2AddLeafEntryPO(1, new byte[] { 2, 4 }, new byte[] { 4, 2 });
