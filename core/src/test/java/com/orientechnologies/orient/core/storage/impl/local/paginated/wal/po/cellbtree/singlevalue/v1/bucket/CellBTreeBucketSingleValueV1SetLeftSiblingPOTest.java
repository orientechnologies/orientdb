...
public class CellBTreeBucketSingleValueV1SetLeftSiblingPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final CellBTreeBucketSingleValueV1SetLeftSiblingPO pageOperation =
          (CellBTreeBucketSingleValueV1SetLeftSiblingPO) operations.get(0);
  ...
  public void testSerialization() {
    CellBTreeBucketSingleValueV1SetLeftSiblingPO operation =
        new CellBTreeBucketSingleValueV1SetLeftSiblingPO(42, 24);
    ...
    CellBTreeBucketSingleValueV1SetLeftSiblingPO restoredOperation =
        new CellBTreeBucketSingleValueV1SetLeftSiblingPO();
