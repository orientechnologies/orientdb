...
public class CellBTreeNullBucketSingleValueV3InitPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final CellBTreeNullBucketSingleValueV3InitPO pageOperation = (CellBTreeNullBucketSingleValueV3InitPO) operations.get(0);
      ...
      CellBTreeSingleValueV3NullBucket restoredPage = new CellBTreeSingleValueV3NullBucket(restoredCacheEntry);
