...
public class CellBTreeMultiValueV2BucketAppendNewLeafEntryPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(
          operations.get(0) instanceof CellBTreeMultiValueV2BucketAppendNewLeafEntryPO);

      final CellBTreeMultiValueV2BucketAppendNewLeafEntryPO pageOperation =
          (CellBTreeMultiValueV2BucketAppendNewLeafEntryPO) operations.get(0);
  ...
  public void testSerialization() {
    CellBTreeMultiValueV2BucketAppendNewLeafEntryPO operation =
        new CellBTreeMultiValueV2BucketAppendNewLeafEntryPO(1, new ORecordId(5, 5));
    ...
    CellBTreeMultiValueV2BucketAppendNewLeafEntryPO restoredOperation =
        new CellBTreeMultiValueV2BucketAppendNewLeafEntryPO();
