...
public class CellBTreeMultiValueV2BucketRemoveLeafEntryPOTest {
  ...
  public void testRedoMainEntry() {
    ...
    try {
      ...
      final CellBTreeMultiValueV2BucketRemoveLeafEntryPO pageOperation =
          (CellBTreeMultiValueV2BucketRemoveLeafEntryPO) operations.get(0);
  ...
  public void testRedoMainSeveralEntries() {
    ...
    try {
      ...
      final CellBTreeMultiValueV2Bucket.LeafEntry addLeafEntry =
          new CellBTreeMultiValueV2Bucket.LeafEntry(
              new byte[] {4},
              4,
              Arrays.asList(
                  new ORecordId[] {new ORecordId(4, 4), new ORecordId(5, 5), new ORecordId(6, 6)}),
              3);
  ...
  public void testSerialization() {
    CellBTreeMultiValueV2BucketRemoveLeafEntryPO operation =
        new CellBTreeMultiValueV2BucketRemoveLeafEntryPO(1, new ORecordId(5, 5));
    ...
    CellBTreeMultiValueV2BucketRemoveLeafEntryPO restoredOperation =
        new CellBTreeMultiValueV2BucketRemoveLeafEntryPO();
