...
public class CellBTreeBucketSingleValueV3AddNonLeafEntryPOTest {
  @Test
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(operations.get(0) instanceof CellBTreeBucketSingleValueV3AddNonLeafEntryPO);

      final CellBTreeBucketSingleValueV3AddNonLeafEntryPO pageOperation = (CellBTreeBucketSingleValueV3AddNonLeafEntryPO) operations
          .get(0);
      ...
      Assert.assertEquals(new CellBTreeSingleValueBucketV3.SBTreeEntry<>(1, 2, (byte) 0, null),
          restoredBucket.getEntry(0, OByteSerializer.INSTANCE));
      Assert.assertEquals(new CellBTreeSingleValueBucketV3.SBTreeEntry<>(2, 4, (byte) 2, null),
      ...
      Assert.assertEquals(new CellBTreeSingleValueBucketV3.SBTreeEntry<>(1, 2, (byte) 0, null),
          restoredBucket.getEntry(0, OByteSerializer.INSTANCE));
      Assert.assertEquals(new CellBTreeSingleValueBucketV3.SBTreeEntry<>(2, 3, (byte) 1, null),
          restoredBucket.getEntry(1, OByteSerializer.INSTANCE));
      Assert.assertEquals(new CellBTreeSingleValueBucketV3.SBTreeEntry<>(3, 4, (byte) 2, null),
  ...
  public void testSerialization() {
    ...
    CellBTreeBucketSingleValueV3AddNonLeafEntryPO operation = new CellBTreeBucketSingleValueV3AddNonLeafEntryPO(12,
        new byte[] { 4, 2 }, true, 12, 45, 67);
    ...
    CellBTreeBucketSingleValueV3AddNonLeafEntryPO restoredOperation = new CellBTreeBucketSingleValueV3AddNonLeafEntryPO();
