...
public class CellBTreeMultiValueV3BucketRemoveNonLeafEntryPOTest {
  @Test
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(operations.get(0) instanceof CellBTreeMultiValueV3BucketRemoveNonLeafEntryPO);

      final CellBTreeMultiValueV3BucketRemoveNonLeafEntryPO pageOperation = (CellBTreeMultiValueV3BucketRemoveNonLeafEntryPO) operations
          .get(0);
  ...
  public void testSerialization() {
    ...
    CellBTreeMultiValueV3BucketRemoveNonLeafEntryPO operation = new CellBTreeMultiValueV3BucketRemoveNonLeafEntryPO(24,
    ...
    CellBTreeMultiValueV3BucketRemoveNonLeafEntryPO restoredOperation = new CellBTreeMultiValueV3BucketRemoveNonLeafEntryPO();
