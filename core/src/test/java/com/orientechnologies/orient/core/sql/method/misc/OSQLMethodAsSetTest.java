...
public class OSQLMethodAsSetTest {
  ...
  public void testIterableOrder() {
    ...
    ArrayList<Integer> values =
        new ArrayList<Integer>(IntStream.rangeClosed(0, 1000).boxed().collect(Collectors.toList()));
    ...
    Assert.assertEquals(values, ((Set<?>) result).stream().collect(Collectors.toList()));
  }
}
