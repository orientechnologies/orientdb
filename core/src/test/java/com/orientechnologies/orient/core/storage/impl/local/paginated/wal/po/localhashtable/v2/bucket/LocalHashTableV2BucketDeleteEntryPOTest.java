...
public class LocalHashTableV2BucketDeleteEntryPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final LocalHashTableV2BucketDeleteEntryPO pageOperation =
          (LocalHashTableV2BucketDeleteEntryPO) operations.get(0);
  ...
  public void testSerialization() {
    LocalHashTableV2BucketDeleteEntryPO operation =
        new LocalHashTableV2BucketDeleteEntryPO(1, 24, new byte[] {1, 2}, new byte[] {3, 4});
    ...
    LocalHashTableV2BucketDeleteEntryPO restoredOperation =
        new LocalHashTableV2BucketDeleteEntryPO();
