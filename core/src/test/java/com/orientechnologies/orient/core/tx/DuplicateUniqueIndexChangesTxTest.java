...
public class DuplicateUniqueIndexChangesTxTest {
  ...
  public void beforeMethod() {
    ...
    class_.createProperty("name", OType.STRING);
    index = class_.createIndex("Person.name", "UNIQUE_HASH_INDEX", null, new ODocument().field("ignoreNullValues", false),
        new String[] { "name" });
  }
