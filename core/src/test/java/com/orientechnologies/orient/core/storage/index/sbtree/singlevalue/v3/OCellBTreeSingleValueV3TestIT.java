...
public class OCellBTreeSingleValueV3TestIT {
  ...
  public void before() throws Exception {
    ...
    singleValueTree = new OCellBTreeSingleValueV3<>("singleBTreeV3", ".sbt", ".nbt",
  ...
  public void testKeyCursor() throws Exception {
    ...
    final OCellBTreeSingleValueV3.OSBTreeKeyCursor<String> cursor = singleValueTree.keyCursor();
  ...
  private void assertIterateMajorEntries(NavigableMap<String, ORID> keyValues, Random random, boolean keyInclusive,
    ...
    for (int i = 0; i < 100; i++) {
      ...
      final OCellBTreeSingleValueV3.OSBTreeCursor<String, ORID> cursor = singleValueTree
  ...
  private void assertIterateBetweenEntries(NavigableMap<String, ORID> keyValues, Random random, boolean fromInclusive,
    ...
    for (int i = 0; i < 100; i++) {
      ...
      OCellBTreeSingleValueV3.OSBTreeCursor<String, ORID> cursor = singleValueTree
