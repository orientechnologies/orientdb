...
public class CellBTreeBucketSingleValueV3AddAllPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final CellBTreeBucketSingleValueV3AddAllPO pageOperation =
          (CellBTreeBucketSingleValueV3AddAllPO) operations.get(0);
  ...
  public void testSerialization() {
    ...
    CellBTreeBucketSingleValueV3AddAllPO operation =
        new CellBTreeBucketSingleValueV3AddAllPO(3, rawRecords, OIntegerSerializer.INSTANCE);
    ...
    CellBTreeBucketSingleValueV3AddAllPO restoredOperation =
        new CellBTreeBucketSingleValueV3AddAllPO();
