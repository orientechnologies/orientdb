...
public class OCreateSBTreeBonsaiRawOperationTest {
  @Test
  public void testSerializationArray() {
    OOperationUnitId unitId = OOperationUnitId.generateId();
    final OCreateSBTreeBonsaiRawOperation createSBTreeBonsaiOperation = new OCreateSBTreeBonsaiRawOperation(unitId, 42, "caprica");
    ...
    final OCreateSBTreeBonsaiRawOperation restoredSBTreeBonsaiOperation = new OCreateSBTreeBonsaiRawOperation();
