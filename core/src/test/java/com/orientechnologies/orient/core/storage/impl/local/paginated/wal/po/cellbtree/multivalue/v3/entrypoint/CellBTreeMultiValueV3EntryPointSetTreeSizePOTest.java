...
public class CellBTreeMultiValueV3EntryPointSetTreeSizePOTest {
  @Test
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(operations.get(0) instanceof CellBTreeMultiValueV3EntryPointSetTreeSizePO);

      final CellBTreeMultiValueV3EntryPointSetTreeSizePO pageOperation = (CellBTreeMultiValueV3EntryPointSetTreeSizePO) operations
          .get(0);
  ...
  public void testSerialization() {
    ...
    CellBTreeMultiValueV3EntryPointSetTreeSizePO operation = new CellBTreeMultiValueV3EntryPointSetTreeSizePO(12, 21);
    ...
    CellBTreeMultiValueV3EntryPointSetTreeSizePO restoredOperation = new CellBTreeMultiValueV3EntryPointSetTreeSizePO();
