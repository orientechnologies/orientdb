...
public class LocalHashTableV2BucketAddEntryPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final LocalHashTableV2BucketAddEntryPO pageOperation = (LocalHashTableV2BucketAddEntryPO) operations.get(0);
      ...
      OHashTable.Entry<Byte, Byte> bucketEntry = restoredBucket
          .getEntry(0, null, OByteSerializer.INSTANCE, OByteSerializer.INSTANCE);
      ...
      bucketEntry = restoredBucket.getEntry(0, null, OByteSerializer.INSTANCE, OByteSerializer.INSTANCE);
      Assert.assertEquals(Byte.valueOf((byte) 2), bucketEntry.value);
      Assert.assertEquals(Byte.valueOf((byte) 1), bucketEntry.key);
      Assert.assertEquals(1, bucketEntry.hashCode);

      bucketEntry = restoredBucket.getEntry(1, null, OByteSerializer.INSTANCE, OByteSerializer.INSTANCE);
  ...
  public void testSerialization() {
    ...
    LocalHashTableV2BucketAddEntryPO operation = new LocalHashTableV2BucketAddEntryPO(1, 24, new byte[] { 1, 2 },
        new byte[] { 3, 4 });
