...
public class OCellBTreeSingleValueV1TestIT {
  ...
  public void before() throws Exception {
    ...
    singleValueTree = new OCellBTreeSingleValueV1<>("singleBTree", ".sbt", ".nbt",
  ...
  public void testKeyCursor() throws Exception {
    ...
    final OCellBTreeSingleValueV1.OSBTreeKeyCursor<String> cursor = singleValueTree.keyCursor();
  ...
  private void assertIterateMajorEntries(NavigableMap<String, ORID> keyValues, Random random, boolean keyInclusive,
    ...
    for (int i = 0; i < 100; i++) {
      ...
      final OCellBTreeSingleValueV1.OSBTreeCursor<String, ORID> cursor = singleValueTree
  ...
  private void assertIterateBetweenEntries(NavigableMap<String, ORID> keyValues, Random random, boolean fromInclusive,
    ...
    for (int i = 0; i < 100; i++) {
      ...
      OCellBTreeSingleValueV1.OSBTreeCursor<String, ORID> cursor = singleValueTree
