...
public class LocalHashTableV2BucketUpdateEntryPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final LocalHashTableV2BucketUpdateEntryPO pageOperation =
          (LocalHashTableV2BucketUpdateEntryPO) operations.get(0);
  ...
  public void testSerialization() {
    LocalHashTableV2BucketUpdateEntryPO operation =
        new LocalHashTableV2BucketUpdateEntryPO(1, new byte[] {1, 2}, new byte[] {3, 4}, 12);
    ...
    LocalHashTableV2BucketUpdateEntryPO restoredOperation =
        new LocalHashTableV2BucketUpdateEntryPO();
