...
public class CellBTreeMultiValueV2BucketShrinkLeafEntriesPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(
          operations.get(0) instanceof CellBTreeMultiValueV2BucketShrinkLeafEntriesPO);

      final CellBTreeMultiValueV2BucketShrinkLeafEntriesPO pageOperation =
          (CellBTreeMultiValueV2BucketShrinkLeafEntriesPO) operations.get(0);
  ...
  public void testSerialization() {
    ...
    CellBTreeMultiValueV2BucketShrinkLeafEntriesPO operation =
    ...
    CellBTreeMultiValueV2BucketShrinkLeafEntriesPO restoredOperation =
        new CellBTreeMultiValueV2BucketShrinkLeafEntriesPO();
    ...
    final List<CellBTreeMultiValueV2Bucket.LeafEntry> restoredLeafEntries =
        restoredOperation.getRemovedEntries();
