...
public class OAtomicUnitEndRecordV2Test {
  ...
  public void recordMetadataSerializationTest() {
    ...
    OAtomicUnitEndRecord atomicUnitEndRecord = new OAtomicUnitEndRecordV2(42L, false, metadata);
    ...
    OAtomicUnitEndRecord atomicUnitEndRecordD = new OAtomicUnitEndRecordV2();
  ...
  public void recordNoMetadataSerializationTest() {
    OAtomicUnitEndRecord atomicUnitEndRecord = new OAtomicUnitEndRecordV2(42L, false, null);
    int arraySize = atomicUnitEndRecord.serializedSize() + 1;
    byte[] content = new byte[arraySize];
