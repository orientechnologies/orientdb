...
public class CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPOTest {
  @Test
  public void testRedo() {
    ...
    try {
      ...
      final CellBTreeMultiValueV2Bucket.NonLeafEntry nonLeafEntryOne =
          new CellBTreeMultiValueV2Bucket.NonLeafEntry(new byte[] {2}, 2, 3);
      final CellBTreeMultiValueV2Bucket.NonLeafEntry nonLeafEntryTwo =
          new CellBTreeMultiValueV2Bucket.NonLeafEntry(new byte[] {3}, 3, 4);
      final CellBTreeMultiValueV2Bucket.NonLeafEntry nonLeafEntryThree =
          new CellBTreeMultiValueV2Bucket.NonLeafEntry(new byte[] {4}, 4, 5);
      ...
      Assert.assertTrue(
          operations.get(0) instanceof CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPO);

      final CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPO pageOperation =
          (CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPO) operations.get(0);
  ...
  public void testSerialization() {
    ...
    final CellBTreeMultiValueV2Bucket.NonLeafEntry nonLeafEntryOne =
        new CellBTreeMultiValueV2Bucket.NonLeafEntry(new byte[] {2}, 1, 2);
    final CellBTreeMultiValueV2Bucket.NonLeafEntry nonLeafEntryTwo =
        new CellBTreeMultiValueV2Bucket.NonLeafEntry(new byte[] {3}, 2, 3);

    nonLeafEntries.add(nonLeafEntryOne);
    nonLeafEntries.add(nonLeafEntryTwo);

    CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPO operation =
        new CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPO(
            12, nonLeafEntries, OByteSerializer.INSTANCE, true);
    ...
    CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPO restoredOperation =
        new CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPO();
    ...
    final List<CellBTreeMultiValueV2Bucket.NonLeafEntry> restoredLeafEntries =
        restoredOperation.getNonLeafEntries();
    Assert.assertEquals(2, restoredLeafEntries.size());

    final CellBTreeMultiValueV2Bucket.NonLeafEntry restoredNonLeafEntryOne =
        restoredLeafEntries.get(0);
    ...
    final CellBTreeMultiValueV2Bucket.NonLeafEntry restoredNonLeafEntryTwo =
        restoredLeafEntries.get(1);
