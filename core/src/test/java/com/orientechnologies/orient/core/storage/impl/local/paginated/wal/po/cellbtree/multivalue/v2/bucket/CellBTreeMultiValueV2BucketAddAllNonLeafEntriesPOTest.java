...
public class CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(operations.get(0) instanceof CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPO);

      final CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPO pageOperation = (CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPO) operations
          .get(0);
  ...
  public void testSerialization() {
    ...
    CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPO operation = new CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPO(12,
    ...
    CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPO restoredOperation = new CellBTreeMultiValueV2BucketAddAllNonLeafEntriesPO();
    ...
    final List<CellBTreeMultiValueV2Bucket.NonLeafEntry> restoredLeafEntries = restoredOperation.getNonLeafEntries();
