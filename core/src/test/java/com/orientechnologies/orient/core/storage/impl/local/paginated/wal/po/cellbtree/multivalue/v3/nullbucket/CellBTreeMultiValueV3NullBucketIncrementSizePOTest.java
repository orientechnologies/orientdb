...
public class CellBTreeMultiValueV3NullBucketIncrementSizePOTest {
  @Test
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(operations.get(0) instanceof CellBTreeMultiValueV3NullBucketIncrementSizePO);

      final CellBTreeMultiValueV3NullBucketIncrementSizePO pageOperation = (CellBTreeMultiValueV3NullBucketIncrementSizePO) operations
          .get(0);
