...
public class CellBTreeMultiValueV3NullBucketRemoveValuePOTest {
  @Test
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(operations.get(0) instanceof CellBTreeMultiValueV3NullBucketRemoveValuePO);

      final CellBTreeMultiValueV3NullBucketRemoveValuePO pageOperation = (CellBTreeMultiValueV3NullBucketRemoveValuePO) operations
          .get(0);
  ...
  public void testSerialization() {
    ...
    CellBTreeMultiValueV3NullBucketRemoveValuePO operation = new CellBTreeMultiValueV3NullBucketRemoveValuePO(
        new ORecordId(12, 34));
    ...
    CellBTreeMultiValueV3NullBucketRemoveValuePO restoredOperation = new CellBTreeMultiValueV3NullBucketRemoveValuePO();
