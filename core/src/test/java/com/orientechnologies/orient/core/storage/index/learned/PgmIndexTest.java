...
public class PgmIndexTest {
    ...
    public void setup() {
        ...
        pgmIndex = new PgmIndex<Integer>(EPSILON, data);
    }
    ...
    protected static List<Integer> generateData(final int numberEntries, final int mustInclude, final Random random) {
