...
public class LocalHashTableRollbackIT {
  ...
  public void testPut() {
    ...
    try (OrientDB orientDB = new OrientDB("plocal:" + orientDirectory, OrientDBConfig.defaultConfig())) {
      ...
      try (ODatabaseSession session = orientDB.open(dbName, "admin", "admin")) {
        ...
        cls.createIndex("value_index", OClass.INDEX_TYPE.UNIQUE_HASH_INDEX, "value");
        cls.createIndex("secondary_value_index", OClass.INDEX_TYPE.NOTUNIQUE_HASH_INDEX, "value");
      }
  ...
  public void testPutCamelCase() {
    ...
    try (OrientDB orientDB = new OrientDB("plocal:" + orientDirectory, OrientDBConfig.defaultConfig())) {
      ...
      try (ODatabaseSession session = orientDB.open(dbName, "admin", "admin")) {
        ...
        final OClass cls = schema.createClass("testPut");
        cls.createProperty("value", OType.STRING);
        cls.createIndex("ValueIndex", OClass.INDEX_TYPE.UNIQUE_HASH_INDEX, "value");
        cls.createIndex("SecondaryValueIndex", OClass.INDEX_TYPE.NOTUNIQUE_HASH_INDEX, "value");
      }
