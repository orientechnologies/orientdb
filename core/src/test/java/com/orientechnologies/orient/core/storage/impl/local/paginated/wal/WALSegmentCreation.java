...
public class WALSegmentCreation {
  ...
  public void beforeClass() throws Exception {
    ...
    writeAheadLog = new ODiskWriteAheadLog(400, 500, 64 * 1024L * 1024L, 64 * 64 * 1024L * 1024L, localPaginatedStorage);
  ...
  public void testLogSegmentCreation() throws Exception {
    ...
    writeAheadLog = new ODiskWriteAheadLog(200, 500, 64 * 1024L * 1024L, 64 * 64 * 1024L * 1024L, localPaginatedStorage);
  ...
  public class Writer implements Callable<Void> {
    ...
    public Void call() throws Exception {
      ...
      while (!stop) {
        ...
        writeAheadLog.log(new TestRecordOne(100, operationUnitId));
        writeAheadLog.logAtomicOperationEndRecord(operationUnitId, false);
        writeAheadLog.log(new TestRecordTwo(100));
      }
