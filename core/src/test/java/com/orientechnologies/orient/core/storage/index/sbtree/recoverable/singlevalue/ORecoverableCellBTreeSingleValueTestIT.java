...
import com.orientechnologies.orient.core.storage.index.sbtree.singlevalue.OCellBTreeSingleValueTestIT;
...
public class ORecoverableCellBTreeSingleValueTestIT {
  private ORecoverableCellBTreeSingleValue<String> singleValueTree;
  ...
  public void before() throws Exception {
    ...
    dbName = "localRecoverableSingleBTreeTest";
    ...
    singleValueTree = new ORecoverableCellBTreeSingleValue<>("singleBTree", ".cbt", ".nbt", ".nlbt",
  ...
  public void testKeyCursor() throws Exception {
    ...
    final ORecoverableCellBTreeSingleValue.OSBTreeKeyCursor<String> cursor = singleValueTree.keyCursor();
  ...
  private void assertIterateMajorEntries(NavigableMap<String, ORID> keyValues, Random random, boolean keyInclusive,
    ...
    for (int i = 0; i < 100; i++) {
      ...
      final ORecoverableCellBTreeSingleValue.OSBTreeCursor<String, ORID> cursor = singleValueTree
  ...
  private void assertIterateBetweenEntries(NavigableMap<String, ORID> keyValues, Random random, boolean fromInclusive,
    ...
    for (int i = 0; i < 100; i++) {
      ...
      ORecoverableCellBTreeSingleValue.OSBTreeCursor<String, ORID> cursor = singleValueTree
