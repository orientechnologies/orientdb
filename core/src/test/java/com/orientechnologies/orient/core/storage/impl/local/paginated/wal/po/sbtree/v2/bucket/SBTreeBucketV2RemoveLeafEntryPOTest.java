...
public class SBTreeBucketV2RemoveLeafEntryPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final SBTreeBucketV2RemoveLeafEntryPO pageOperation =
          (SBTreeBucketV2RemoveLeafEntryPO) operations.get(0);
  ...
  public void testSerialization() {
    SBTreeBucketV2RemoveLeafEntryPO operation =
        new SBTreeBucketV2RemoveLeafEntryPO(1, new byte[] {2, 4}, new byte[] {4, 2});
