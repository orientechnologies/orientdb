...
public class CellBTreeMultiValueV2BucketShrinkNonLeafEntriesPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      Assert.assertTrue(
          operations.get(0) instanceof CellBTreeMultiValueV2BucketShrinkNonLeafEntriesPO);

      final CellBTreeMultiValueV2BucketShrinkNonLeafEntriesPO pageOperation =
          (CellBTreeMultiValueV2BucketShrinkNonLeafEntriesPO) operations.get(0);
  ...
  public void testSerialization() {
    ...
    CellBTreeMultiValueV2BucketShrinkNonLeafEntriesPO operation =
    ...
    CellBTreeMultiValueV2BucketShrinkNonLeafEntriesPO restoredOperation =
        new CellBTreeMultiValueV2BucketShrinkNonLeafEntriesPO();
