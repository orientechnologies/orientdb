...
public class CellBTreeBucketSingleValueV3AddLeafEntryPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final CellBTreeBucketSingleValueV3AddLeafEntryPO pageOperation =
          (CellBTreeBucketSingleValueV3AddLeafEntryPO) operations.get(0);
  ...
  public void testSerialization() {
    CellBTreeBucketSingleValueV3AddLeafEntryPO operation =
        new CellBTreeBucketSingleValueV3AddLeafEntryPO(1, new byte[] {2, 4}, new byte[] {4, 2});
    ...
    CellBTreeBucketSingleValueV3AddLeafEntryPO restoredOperation =
        new CellBTreeBucketSingleValueV3AddLeafEntryPO();
