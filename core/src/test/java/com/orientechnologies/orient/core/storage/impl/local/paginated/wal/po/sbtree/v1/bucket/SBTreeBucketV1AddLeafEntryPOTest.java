...
public class SBTreeBucketV1AddLeafEntryPOTest {
  ...
  public void testRedo() {
    ...
    try {
      ...
      final SBTreeBucketV1AddLeafEntryPO pageOperation =
          (SBTreeBucketV1AddLeafEntryPO) operations.get(0);
  ...
  public void testSerialization() {
    SBTreeBucketV1AddLeafEntryPO operation =
        new SBTreeBucketV1AddLeafEntryPO(1, new byte[] {2, 4}, new byte[] {4, 2});
