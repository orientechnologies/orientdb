...
public class SBTreeBucketV1AddLeafEntryPOTest {
  @Test
  public void testRedo() {
    ...
    try {
      ...
      bucket.addLeafEntry(1, new byte[] { 2 }, OLinkSerializer.INSTANCE.serializeNativeAsWhole(new ORecordId(2, 2)));
      ...
      Assert.assertTrue(operations.get(0) instanceof SBTreeBucketV1AddLeafEntryPO);

      final SBTreeBucketV1AddLeafEntryPO pageOperation = (SBTreeBucketV1AddLeafEntryPO) operations.get(0);
  ...
  public void testSerialization() {
    ...
    SBTreeBucketV1AddLeafEntryPO operation = new SBTreeBucketV1AddLeafEntryPO(1, new byte[] { 2, 4 }, new byte[] { 4, 2 });
    ...
    SBTreeBucketV1AddLeafEntryPO restoredOperation = new SBTreeBucketV1AddLeafEntryPO();
