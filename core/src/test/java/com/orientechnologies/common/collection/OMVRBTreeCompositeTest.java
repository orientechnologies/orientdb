...
public class OMVRBTreeCompositeTest {
    ...
    public void testGetEntrySameKeys() {
        OMVRBTreeEntry<OCompositeKey, Double> result = tree.getEntry(compositeKey(1.0, 2.0),
                OMVRBTree.PartialSearchMode.NONE);
    ...
    public void testGetEntryPartialKeys() {
        OMVRBTreeEntry<OCompositeKey, Double> result = tree.getEntry(compositeKey(2.0),
                OMVRBTree.PartialSearchMode.NONE);
    ...
    public void testSubMapInclusiveDescending() {
        final ONavigableMap<OCompositeKey, Double> navigableMap = tree.subMap(compositeKey(2.0), true,
                compositeKey(3.0), true).descendingMap();
    ...
    public void testSubMapFromInclusiveDescending() {
        final ONavigableMap<OCompositeKey, Double> navigableMap = tree.subMap(compositeKey(2.0), true,
                compositeKey(3.0), false).descendingMap();
    ...
    public void testSubMapToInclusiveDescending() {
        final ONavigableMap<OCompositeKey, Double> navigableMap = tree.subMap(compositeKey(2.0), false,
                compositeKey(3.0), true).descendingMap();
    ...
    public void testSubMapNonInclusiveDescending() {
        ONavigableMap<OCompositeKey, Double> navigableMap = tree.subMap(compositeKey(2.0), false,
                compositeKey(3.0), false).descendingMap();
    ...
    public void testSubMapInclusivePartialKey() {
        final ONavigableMap<OCompositeKey, Double> navigableMap = tree.subMap(compositeKey(2.0, 4.0), true,
                compositeKey(3.0), true);
    ...
    public void testSubMapToInclusivePartialKey() {
        final ONavigableMap<OCompositeKey, Double> navigableMap = tree.subMap(compositeKey(2.0, 4.0), false,
                compositeKey(3.0), true);
    ...
    public void testSubMapNonInclusivePartial() {
        ONavigableMap<OCompositeKey, Double> navigableMap = tree.subMap(compositeKey(2.0, 4.0), false,
                compositeKey(3.0), false);
    ...
    public void testGetCeilingEntryKeyExistPartial() {
        OMVRBTreeEntry<OCompositeKey, Double> entry =
                tree.getCeilingEntry(compositeKey(3.0), OMVRBTree.PartialSearchMode.NONE);
    ...
    public void testGetCeilingEntryKeyNotExistPartial() {
        OMVRBTreeEntry<OCompositeKey, Double> entry =
                tree.getCeilingEntry(compositeKey(1.3), OMVRBTree.PartialSearchMode.NONE);
    ...
    public void testGetFloorEntryKeyExistPartial() {
        OMVRBTreeEntry<OCompositeKey, Double> entry =
                tree.getFloorEntry(compositeKey(2.0), OMVRBTree.PartialSearchMode.NONE);
        assertEquals(entry.getKey().getKeys().get(0), 2.0);
    ...
    public void testGetFloorEntryKeyNotExistPartial() {
        OMVRBTreeEntry<OCompositeKey, Double> entry =
                tree.getFloorEntry(compositeKey(1.3), OMVRBTree.PartialSearchMode.NONE);
