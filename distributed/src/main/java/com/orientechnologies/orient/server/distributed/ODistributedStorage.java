...
public class ODistributedStorage implements OStorage, OFreezableStorage, OAutoshardedStorage {
  ...
  protected final OHazelcastPlugin                                   dManager;
  ...
  public ODistributedStorage(final OServer iServer, final OAbstractPaginatedStorage wrapped) {
    ...
    this.dManager = (OHazelcastPlugin) iServer.getDistributedManager();
  ...
  public Object command(final OCommandRequestText iCommand) {
    ...
    try {
      ...
      if (result instanceof OSerializableWrappedResponse)
        result = ((OSerializableWrappedResponse) result).getWrapped();
