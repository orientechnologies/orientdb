...
public class ODatabaseConfigurationFetch extends OAbstractRemoteTask {
  ...
  public Object execute(
    ...
    OrientDBDistributed distributed = ((OrientDBDistributed) iServer.getDatabases());
    ODistributedConfiguration config = distributed.getExistingDatabaseConfiguration(this.database);
    if (config != null) {
