...
public class ShutdownAndRestartNodeScenarioTest extends AbstractScenarioTest {
    ...
    private class TestQuorum2 implements Callable<Void>  {
        ...
        public Void call() throws Exception {
            ...
            final ODatabaseDocumentTx dbServer3 = new ODatabaseDocumentTx(databaseUrl).open("admin", "admin");
    ...
    private class TestQuorum3 implements Callable<Void>  {
        ...
        public Void call() throws Exception {
             ...
             */
                ...
                System.out.print("Checking the last record wasn't inserted in the db beacause the quorum was not reached...");
