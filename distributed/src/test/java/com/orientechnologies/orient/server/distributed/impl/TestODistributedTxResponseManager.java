...
public class TestODistributedTxResponseManager {
  ...
  public void testSimpleQuorum() {
    ...
    ONodeId one = new ONodeId("one");
    ONodeId two = new ONodeId("two");
    ONodeId three = new ONodeId("three");
  ...
  public void testSimpleQuorumLocal() {
    ...
    assertFalse(
        responseManager.collectResponse(new OTransactionPhase1TaskResult(new OTxSuccess()), three));
    assertTrue(responseManager.isQuorumReached());
  }
