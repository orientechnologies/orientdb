...
public class BasicSyncIT {
  ...
  public void before() throws Exception {
    ...
    OrientDB remote =
        new OrientDB(setup.getRemoteAddress(), "root", "test", OrientDBConfig.defaultConfig());
  ...
  public void sync2()
    ...
    // nodeParams.get(0).get(StatefulSetTemplateKeys.ORIENTDB_BINARY_ADDRESS);
    ...
    //    }
    //    // Test server 1
    //    try (OrientDB remote = new OrientDB("remote:localhost:2425",
    ...
    //    }
    //    // Test server 2
    //    try (OrientDB remote = new OrientDB("remote:localhost:2426",
    // OrientDBConfig.defaultConfig())) {
    //      try (ODatabaseSession session = remote.open("test", "admin", "admin")) {
    //        assertEquals(session.countClass("One"), 3);
    //      }
