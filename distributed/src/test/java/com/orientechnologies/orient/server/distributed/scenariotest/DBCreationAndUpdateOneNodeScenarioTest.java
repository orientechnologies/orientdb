 ...
 * - check consistency: db created on the other servers and all the records are consistent
 */
...
public class DBCreationAndUpdateOneNodeScenarioTest extends AbstractScenarioTest {
    ...
    public void executeTest() throws Exception {
        ...
        String url1 = "plocal:target/server0/databases/new-distirbuted-db";
        String url2 = "plocal:target/server1/databases/new-distirbuted-db";
        String url3 = "plocal:target/server2/databases/new-distirbuted-db";
