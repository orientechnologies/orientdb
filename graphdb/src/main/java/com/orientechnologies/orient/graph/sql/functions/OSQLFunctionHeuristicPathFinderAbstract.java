...
public abstract class OSQLFunctionHeuristicPathFinderAbstract extends OSQLFunctionMathAbstract {
  ...
  protected double getCustomHeuristicCost(final String functionName, final String[] vertextAxisNames, final OrientVertex start,
      final OrientVertex goal, final OrientVertex current, final OrientVertex parent, final long depth, double dFactor) {
