...
//    new OInternalGraphImporter().runImport(inputFile, dbURL);
    new OInternalGraphImporter().runImportCustom(inputFile, dbURL);
    Orient.instance().shutdown();

  }


  public void runImportCustom(String inputFile, String dbURL) throws IOException {
  ...
  public void runImport(String inputFile, String dbURL) throws IOException, FileNotFoundException {
    ...
    OConsoleDatabaseApp console = new OGremlinConsole(new String[] { "import database " + inputFile + " -merge=true"}).setCurrentDatabase(g.getRawGraph());
