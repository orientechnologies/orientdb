...
call %JAVA% -client %ORIENTDB_SETTINGS% -Dfile.encoding=utf-8 -Dorientdb.build.number="@BUILD@" -cp "%ORIENTDB_HOME%\lib\*;%ORIENTDB_HOME%\lib\console*;" com.orientechnologies.orient.console.OConsoleDatabaseApp %CMD_LINE_ARGS%
