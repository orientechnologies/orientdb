  ...
  public void infoClass(@ConsoleParameter(name = "class-name", description = "The name of the class") final String iClassName) {
    ...
    if (cls.properties().size() > 0) {
      ...
      message(
          "\n-------------------------------+-------------+-------------------------------+-----------+----------+----------+-----------+-----------+----------+----------+--------------+");
      message(
          "\n NAME                          | TYPE        | LINKED TYPE/CLASS             | MANDATORY | READONLY | NOT NULL |    MIN    |    MAX    | COLLATE  | DEFAULT  | AUTOGENERATE |");
      message(
          "\n-------------------------------+-------------+-------------------------------+-----------+----------+----------+-----------+-----------+----------+----------+--------------+");

      for (final OProperty p : cls.properties()) {
        try {
          message("\n %-30s| %-12s| %-30s| %-10s| %-9s| %-9s| %-10s| %-10s| %-9s| %-9s| %-13s|", p.getName(), p.getType(),
