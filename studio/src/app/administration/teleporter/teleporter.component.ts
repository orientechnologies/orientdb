...
class TeleporterComponent implements AfterViewChecked {
  ...
  init() {
    ...
    this.hints = {
      ...
      "<a href='https://orientdb.dev/docs/3.2.x/teleporter/Teleporter-Execution-Strategies.html'>More info</a>",
      ...
      "<a href='https://orientdb.dev/docs/3.2.x/teleporter/Teleporter-Inheritance.html'>More info</a>",
