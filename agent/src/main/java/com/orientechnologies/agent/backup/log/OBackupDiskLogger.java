...
public class OBackupDiskLogger implements OBackupLogger {
  ...
  @Override
  public void deleteByUUIDAndUnitIdAndTx(String uuid, Long unitId, Long timestamp) throws IOException {
  ...
  @Override
  public void deleteLog(OBackupLog scheduled) {
    throw new UnsupportedOperationException();
  }

  @Override
  public void updateLog(OBackupLog log) {
    throw new UnsupportedOperationException();
  }
