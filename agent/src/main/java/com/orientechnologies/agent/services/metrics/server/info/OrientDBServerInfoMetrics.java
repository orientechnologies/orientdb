...
public class OrientDBServerInfoMetrics implements OrientDBMetric {
  ...
  public void start() {
    ...
    this.registry.registerAll(OGlobalMetrics.SERVER_INFO.name, new OMetricSet() {
      @Override
      public Map<String, OMetric> getMetrics() {

        Map<String, OMetric> metrics = new HashMap<>();

        metrics.put("databases",
            registry.newGauge("databases", "List of databases", OrientDBServerInfoMetrics.this::getDatabasesList));

        metrics.put("cpus", registry.newGauge("cpus", "Number of CPUs", () -> processors));
        metrics.put("osName", registry.newGauge("osName", "Operating System name", () -> System.getProperty("os.name")));
        metrics
            .put("osVersion", registry.newGauge("osVersion", "Operating System version", () -> System.getProperty("os.version")));
        metrics.put("osArch", registry.newGauge("osArch", "Operating System architecture", () -> System.getProperty("os.arch")));
        metrics.put("javaVendor", registry.newGauge("javaVendor", "Java Vendor", () -> System.getProperty("java.vendor")));
        metrics.put("javaVersion", registry.newGauge("javaVersion", "Java Version", () -> System.getProperty("java.version")));
        metrics.put("version", registry.newGauge("version", "OrientDB Version", () -> OConstants.getRawVersion()));
