...
public class OSBTreeCollectionManagerRemoteTest {
  ...
  public void testCreateTree() throws Exception {
    ...
    when(storageMock.beginRequest(Mockito.any(OChannelBinaryAsynchClient.class),
        eq(OChannelBinaryProtocol.REQUEST_CREATE_SBTREE_BONSAI),
    ...
    verify(storageMock).beginRequest(Mockito.any(OChannelBinaryAsynchClient.class),
        eq(OChannelBinaryProtocol.REQUEST_CREATE_SBTREE_BONSAI),
