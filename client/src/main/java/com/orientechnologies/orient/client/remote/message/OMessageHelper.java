...
public class OMessageHelper {
  ...
  public static void writeTxUniqueIndexKeys(SortedSet<OPair<String, Object>> uniqueIndexKeys,
                                            ORecordSerializerNetworkV37 serializer, DataOutput out) throws IOException {
  ...
  public static void readTxUniqueIndexKeys(SortedSet<OPair<String, Object>> uniqueIndexKeys,
                                           ORecordSerializerNetworkV37 serializer, DataInput in) throws IOException {
    int size = in.readInt();
